...
uses
  ...
  fbAbout_ru in '..\source\bio\ru\fbAbout_ru.pas' {frmAbout},
  fbConstruction_ru in '..\source\bio\ru\fbConstruction_ru.pas' {FormConstruction},
  fbCreatingGalaxy_ru in '..\source\bio\ru\fbCreatingGalaxy_ru.pas' {FormCreatingGalaxy},
  fbEditLine_ru in '..\source\bio\ru\fbEditLine_ru.pas' {FormEditLine},
  fbEvents_ru in '..\source\bio\ru\fbEvents_ru.pas' {FormEvents},
  fbIntro_ru in '..\source\bio\ru\fbIntro_ru.pas' {FormIntro},
  fbKeyboard_ru in '..\source\bio\ru\fbKeyboard_ru.pas' {FormKeyboard},
  fbLists_ru in '..\source\bio\ru\fbLists_ru.pas' {FormLists},
  fbManager_ru in '..\source\bio\ru\fbManager_ru.pas' {FormManager},
  fbMaximums_ru in '..\source\bio\ru\fbMaximums_ru.pas' {FormMaximums},
  fbNewReality_ru in '..\source\bio\ru\fbNewReality_ru.pas' {FormNewReality},
  fbPhotograph_ru in '..\source\bio\ru\fbPhotograph_ru.pas' {FormPhotograph},
  fbReality_ru in '..\source\bio\ru\fbReality_ru.pas' {FormReality},
  fbSatellite_ru in '..\source\bio\ru\fbSatellite_ru.pas' {FormSatellite},
  fbOptions_ru in '..\source\bio\ru\fbOptions_ru.pas' {FormOptions},
  fbSpirit_ru in '..\source\bio\ru\fbSpirit_ru.pas' {FormSpirit},
  vInterfaceClasses in '..\source\bio\vInterfaceClasses.pas',
  fbFirstForm_ru in '..\source\bio\ru\fbFirstForm_ru.pas' {FormFirst},
  vSplashScreen in '..\source\bio\vSplashScreen.pas',
  fbPopulations_ru in '..\source\bio\ru\fbPopulations_ru.pas' {FormPopulations},
  fbHeightField_ru in '..\source\bio\ru\fbHeightField_ru.pas' {FormHeightField},
  fbHumidityMap_ru in '..\source\bio\ru\fbHumidityMap_ru.pas' {FormHumidityMap},
  fbPosition_ru in '..\source\bio\ru\fbPosition_ru.pas' {FormPosition},
  fbDNAR in '..\source\bio\ru\fbDNAR.pas' {FormDNA},
  fbError_ru in '..\source\bio\ru\fbError_ru.pas' {FormError},
  fbTip_ru in '..\source\bio\ru\fbTip_ru.pas' {FormTip},
  fbSplash_ru in '..\source\bio\ru\fbSplash_ru.pas' {FormSplash},
  fbImages_ru in '..\source\bio\ru\fbImages_ru.pas' {frmImages},
  Bio.Things in '..\source\bio\Bio.Things.pas',
  Bio.Utilities in '..\source\bio\Bio.Utilities.pas',
  fbTutorial_ru in '..\source\bio\ru\fbTutorial_ru.pas' {FormTutorial},
  dbImages in '..\source\bio\dbImages.pas' {DataModuleImages: TDataModule},
  fbMiniForm_ru in '..\source\bio\ru\fbMiniForm_ru.pas',
  Astro.Globals in '..\source\astro\Astro.Globals.pas',
  fbBioneta_ru in '..\source\bio\ru\fbBioneta_ru.pas' {FormBioneta},
  vSpiritManager_ru in '..\source\bio\ru\vSpiritManager_ru.pas',

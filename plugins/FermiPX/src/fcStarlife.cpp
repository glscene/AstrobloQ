...
// ---------------------------------------------------------------------------
void __fastcall TFormLife::ButtonStartClick(TObject* Sender)
{
...
void __fastcall TFormLife::ShapeOMouseDown(
...
void __fastcall TFormLife::ShapeBMouseDown(
    TObject* Sender, TMouseButton Button, TShiftState Shift, int X, int Y)
{
...
void __fastcall TFormLife::ShapeAMouseDown(
    TObject* Sender, TMouseButton Button, TShiftState Shift, int X, int Y)
{
...
void __fastcall TFormLife::ShapeFMouseDown(
    TObject* Sender, TMouseButton Button, TShiftState Shift, int X, int Y)
{
...
void __fastcall TFormLife::ShapeGMouseDown(
    TObject* Sender, TMouseButton Button, TShiftState Shift, int X, int Y)
{
...
void __fastcall TFormLife::ShapeKMouseDown(
    TObject* Sender, TMouseButton Button, TShiftState Shift, int X, int Y)
{
...
void __fastcall TFormLife::ShapeMMouseDown(
    TObject* Sender, TMouseButton Button, TShiftState Shift, int X, int Y)
{
...
void __fastcall TFormLife::ButtonStopClick(TObject* Sender)
{
    //Add_Stars[10000]->CleanupInstance();

...
type
  TfrmFermi = class(TForm)
    ...
    procedure miDrakeClick(Sender: TObject);
  private
...
function TfrmFermi.GetDataDir(): TFileName;
var
  path: TFileName;
begin
...
procedure TfrmFermi.FormCreate(Sender: TObject);
begin
...
procedure TfrmFermi.GLCadencerProgress(Sender: TObject; const DeltaTime, NewTime: Double);
begin
...
procedure TfrmFermi.GLSceneViewerDblClick(Sender: TObject);
begin
...
procedure TfrmFermi.GLSceneViewerMouseDown(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
	 mx := X; my := Y;
end;

procedure TfrmFermi.GLSceneViewerMouseMove(Sender: TObject; Shift: TShiftState; X, Y: Integer);
begin
...
procedure TfrmFermi.miSettingsClick(Sender: TObject);
begin
...
//------------------------------------------------------------------
procedure TfrmFermi.miAboutClick(Sender: TObject);
begin
...
procedure TfrmFermi.miDrakeClick(Sender: TObject);
begin
...
procedure TfrmFermi.miExitClick(Sender: TObject);
begin
  Close;
end;

...
*)
  ...
  programObject.AddShader(TGLVertexShaderHandle,
    LoadAnsiStringFromFile('shaders\bump_mapping_vertex.glsl'));

  if parallaxBumpMapping then
    shaderData := LoadAnsiStringFromFile('shaders\parallax_bump_mapping_fragment.glsl')
  else
    shaderData := LoadAnsiStringFromFile('shaders\dot3_bump_mapping_fragment.glsl');

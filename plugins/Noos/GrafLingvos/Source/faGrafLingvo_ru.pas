...
begin
  ...
  begin
    ...
    dmDialogs.OpenDialog.InitialDir := MediaDir;
...
procedure TfrmGLSViewer.GLSimpleNavigationMouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
begin
  inherited;
...
var
  I: Integer;
begin
  dmDialogs.ODTextures.InitialDir := MediaDir;
...
begin
  ...
  frmGLSViewer.Caption := 'GrafLingvos - ' + FileName;
...
begin
  inherited;
  ShellExecute(0, 'open','https://gitverse.ru/glscene', '', '', SW_SHOW);
end;

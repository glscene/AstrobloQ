...
type
  TfmGexoblok = class(TfmInitialForm)
    Layer3D1: TLayer3D;
    Layout3D1: TLayout3D;
    Light1: TLight;
...
procedure TfmGexoblok.DefaultLayout;
begin
  PanelCenter.Visible := True;
  PanelRight.Visible := True;
end;

procedure TfmGexoblok.FormCreate(Sender: TObject);
begin
  inherited;
  ReadIniFile;
  TranslateMainMenu;
...
procedure TfmGexoblok.FormShow(Sender: TObject);
begin
  inherited;
  DefaultLayout;
end;

procedure TfmGexoblok.TranslateMainMenu;
var
  I : Integer;
begin
...
procedure TfmGexoblok.acFileExitCanActionExec(Sender: TCustomAction;
  var CanExec: Boolean);
begin
  Application.Terminate;
end;

procedure TfmGexoblok.acMethodGridGenerationExecute(Sender: TObject);
begin
...
procedure TfmGexoblok.acMethodInterpolationExecute(Sender: TObject);
begin
...
procedure TfmGexoblok.acMethodPitOptimizationExecute(Sender: TObject);
begin
...
procedure TfmGexoblok.acSaveAsExecute(Sender: TObject);
begin
  //Save As
end;

procedure TfmGexoblok.acToolsOptionsExecute(Sender: TObject);
begin
...
procedure TfmGexoblok.acHelpAboutExecute(Sender: TObject);
begin
...
procedure TfmGexoblok.ReadIniFile;
var
  StyleID: integer;
begin
  inherited;
...
procedure TfmGexoblok.sbCenterClick(Sender: TObject);
begin
  FrameShowTable.Visible := not FrameShowTable.Visible;
end;


procedure TfmGexoblok.cbMultiViewChange(Sender: TObject);
begin
  FrameDataBrowser.TreeViewData.ShowCheckboxes := cbMultiView.IsChecked;
end;

procedure TfmGexoblok.sbMultiViewClick(Sender: TObject);
begin
///
end;

procedure TfmGexoblok.WriteIniFile;
begin
  PathExe := ExtractFilePath(ParamStr(0));
  SetCurrentDir(PathExe);
  IniFile := TIniFile.Create(PathExe + 'Gexoblock.ini');
...
procedure TfmGexoblok.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  try

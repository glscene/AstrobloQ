...
uses
  ...
  fxHelpAbout in 'source\fxHelpAbout.pas' {FormHelpAbout},
  fxToolsOptions in 'source\fxToolsOptions.pas' {FormToolsOptions},
  ...
  fxInterpolation in 'source\fxInterpolation.pas' {FormMethodInterpolation},
  fxGeobloq in 'source\fxGeobloq.pas' {frmGeobloq},
  fxGridGeneration in 'source\fxGridGeneration.pas' {FormMethodGridGeneration},
  ...
  fxPitOptimization in 'source\fxPitOptimization.pas' {FormMethodPitOptimization},

...
var
  MainForm: TMainForm;
  dirBin, dirMedia, dirTextures, dirShaders: TFileName;
...
begin
  GetDir(0, dirBin); //dirBin := GetCurrentDir();
  dirMedia := dirBin + '\media';
  dirTextures := dirMedia + '\texture\';
  dirShaders := dirMedia + '\shader\';

(*
  This demo show how a cyclic fractal HDS can be used with an actor.
  ...
  The code is based on the demo ActorTwoCams by Carlos Artaega Rivero.
...
uses
  Forms,
  fmDuneFighter in 'interface\fmDuneFighter.pas' {frmDuneFighter};

...
procedure TfrmSequencer.FormActivate (Sender: TObject);
var eTab: Int32;
begin
   if not active then
   begin
...
procedure TfrmSequencer.FormClose(Sender: TObject; var Action: TCloseAction);
begin
   MIDI_Sequencer.Status := seq_Stop;
   Application.ProcessMessages;
end;

procedure TfrmSequencer.OnTime (Sender: TObject; time, current_event: Int32);
var s: string;
begin
...
procedure TfrmSequencer.File_OpenClick (Sender: TObject);
...
procedure TfrmSequencer.File_Save_AsClick (Sender: TObject);
begin
...
procedure TfrmSequencer.File_PrintClick (Sender: TObject);
var i, h: Int32;
begin
   with Printer do
   begin
...
procedure TfrmSequencer.File_ExitClick (Sender: TObject);
begin
   Application.Terminate;
end; // File_ExitClick //

procedure TfrmSequencer.Edit_ClearClick (Sender: TObject);
begin
   MIDI_Sequencer.Reset;
   Raw_MIDI_Viewer.Lines.Clear;
end; // Edit_ClearClick //

procedure TfrmSequencer.View_EventsClick (Sender: TObject);
begin
//   MIDI_Events_View.show_events;
end; // View_EventsClick //

procedure TfrmSequencer.View_MIDIClick (Sender: TObject);
begin
   Pager.ActivePage := Tab_Events;
end; // View_MIDIClick //

procedure TfrmSequencer.View_InputClick (Sender: TObject);
begin
   Pager.ActivePage := Tab_Res_In;
end; // View_InputClick //

procedure TfrmSequencer.View_OutputClick (Sender: TObject);
begin
   Pager.ActivePage := Tab_Res_Out;
end; // View_OutputClick //

procedure TfrmSequencer.View_ControllersClick (Sender: TObject);
begin
   Pager.ActivePage := Tab_Controllers;
end; // View_ControllersClick //

procedure TfrmSequencer.Play_PlayClick (Sender: TObject);
begin
   Status.SimpleText := 'Playing: ' +  MIDI_Sequencer.MIDI_Container.status;
   xeq_play;
end; // Play_PlayClick //

procedure TfrmSequencer.Play_StopClick (Sender: TObject);
begin
   Status.SimpleText := '';
   xeq_stop;
...
procedure TfrmSequencer.Play_PauseClick (Sender: TObject);
begin
   Status.SimpleText := 'Pausing...';
   xeq_pause;
end; // Play_PauseClick //

procedure TfrmSequencer.Play_StepClick (Sender: TObject);
begin
   Status.SimpleText := 'Stepping...';
   xeq_step;
end; // Play_StepClick //

procedure TfrmSequencer.Play_RewindClick (Sender: TObject);
begin
   Status.SimpleText := 'Rewinding...';
   xeq_rewind;
end; // Play_RewindClick //

procedure TfrmSequencer.Play_RecordClick (Sender: TObject);
begin
   Status.SimpleText := 'Recording...';
   xeq_record;
end; // Play_RecordClick //

procedure TfrmSequencer.Position_Change (Sender: TObject);
...
procedure TfrmSequencer.Track_TempoChange (Sender: TObject);
var temp: TNotifyEvent;
begin
...
procedure TfrmSequencer.Button_AssignClick (Sender: TObject);
...
procedure TfrmSequencer.container_properties;
var max: Int32;
begin
...
procedure TfrmSequencer.xeq_record;
begin
   MIDI_Sequencer.Status := seq_Record;
end; // xeq_record //

procedure TfrmSequencer.xeq_play;
begin
   MIDI_Sequencer.Status := seq_Play;
end; // xeq_play //

procedure TfrmSequencer.xeq_pause;
begin
   MIDI_Sequencer.Status := seq_Pause;
end; // xeq_pause //

procedure TfrmSequencer.xeq_step;
begin
   MIDI_Sequencer.Status := seq_Step;
end; // xeq_step //

procedure TfrmSequencer.xeq_stop;
begin
   MIDI_Sequencer.Status := seq_Stop;
end; // xeq_stop //

procedure TfrmSequencer.xeq_rewind;
begin

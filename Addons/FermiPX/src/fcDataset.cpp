...
#pragma resource "*.dfm"
TFormDataset *FormDataset;
int TablesCount;
String DBname, TableName;
//---------------------------------------------------------------------------
__fastcall TFormDataset::TFormDataset(TComponent* Owner)
	: TForm(Owner)
{
}
//---------------------------------------------------------------------------
...
void __fastcall TFormDataset::GetTables()
{
	...
	RadioGroup2->Caption = DBname + " таблицы:";
	...
	// Добавление списка таблиц в радиогруппу
	if (TablesCount > 0) {
...
//---------------------------------------------------------------------------
void __fastcall TFormDataset::GetTablesData()
{
...
//---------------------------------------------------------------------------
void __fastcall TFormDataset::RadioGroup2Click(TObject *Sender)
{
    GetTablesData();
}
//---------------------------------------------------------------------------

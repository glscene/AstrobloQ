...
## Quick Start
To include Astronomy Engine in your Delphi program, all you need are the
files `astronomy.pas` and `astronomy.dll` from this directory.

To get started quickly, here are some [examples](../../demo/delphi/).

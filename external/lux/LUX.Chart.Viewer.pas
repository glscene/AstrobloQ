...
type
  ...
  public
    constructor Create(const Paren_: TChartViewer);
    destructor Destroy; override;
    property Poins[const I_: Integer]: TSingle2D read GetPoins
      write SetPoins; default;
  ...
  public
    ...
    procedure DrawCirc(const Center_: TSingle2D;
      const Radius_, Opacity_: Single);
  end;
...
begin
  ...
  begin
    ...
    begin
      ...
      for I := 1 to _PoinsN - 1 do
        LineTo(PosToScr(_Poins[I]));
    end;
...
procedure TChartViewer.DrawCirc(const Center_: TSingle2D;
  const Radius_, Opacity_: Single);
var
  R: TRectF;
begin

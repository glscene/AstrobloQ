...
type
  ...
  public
    ...
    class operator Multiply(const A_: TdSingle4D; const B_: TdSingle)
      : TdSingle4D; inline;
    class operator Multiply(const A_: TdSingle; const B_: TdSingle4D)
      : TdSingle4D; inline;
    class operator Divide(const A_: TdSingle4D; const B_: TdSingle)
      : TdSingle4D; inline;
    class operator Implicit(const V_: TSingle4D): TdSingle4D;
    class operator Implicit(const V_: TdSingle4D): TSingle4D;
    case Integer of
      0:
        (_: array [1 .. 4] of TdSingle);
      1:
        (X: TdSingle;
          Y: TdSingle;
          Z: TdSingle;
  ...
  public
    ...
    class operator Multiply(const A_: TdDouble4D; const B_: TdDouble)
      : TdDouble4D; inline;
    class operator Multiply(const A_: TdDouble; const B_: TdDouble4D)
      : TdDouble4D; inline;
    class operator Divide(const A_: TdDouble4D; const B_: TdDouble)
      : TdDouble4D; inline;
    class operator Implicit(const V_: TDouble4D): TdDouble4D;
    class operator Implicit(const V_: TdDouble4D): TDouble4D;
    case Integer of
      0:
        (_: array [1 .. 4] of TdDouble);
      1:
        (X: TdDouble;
          Y: TdDouble;
          Z: TdDouble;
...
function Ave(const P1_, P2_, P3_, P4_: TdSingle4D): TdSingle4D; inline;
  overload;
function Ave(const P1_, P2_, P3_, P4_: TdDouble4D): TdDouble4D; inline;
  overload;
...
class operator TSingle4D.Multiply(const A_: TSingle4D; const B_: Single)
  : TSingle4D;
begin
  with Result do
  begin
...
class operator TSingle4D.Multiply(const A_: Single; const B_: TSingle4D)
  : TSingle4D;
begin
  with Result do
  begin
...
class operator TSingle4D.Divide(const A_: TSingle4D; const B_: Single)
  : TSingle4D;
begin
  with Result do
  begin
...
class operator TDouble4D.Multiply(const A_: TDouble4D; const B_: Double)
  : TDouble4D;
begin
  with Result do
  begin
...
class operator TDouble4D.Multiply(const A_: Double; const B_: TDouble4D)
  : TDouble4D;
begin
  with Result do
  begin
...
class operator TDouble4D.Divide(const A_: TDouble4D; const B_: Double)
  : TDouble4D;
begin
  with Result do
  begin
...
class operator TdSingle4D.Multiply(const A_: TdSingle4D; const B_: TdSingle)
  : TdSingle4D;
begin
  with Result do
  begin
...
class operator TdSingle4D.Multiply(const A_: TdSingle; const B_: TdSingle4D)
  : TdSingle4D;
begin
  with Result do
  begin
...
class operator TdSingle4D.Divide(const A_: TdSingle4D; const B_: TdSingle)
  : TdSingle4D;
begin
  with Result do
  begin
...
class operator TdDouble4D.Multiply(const A_: TdDouble4D; const B_: TdDouble)
  : TdDouble4D;
begin
  with Result do
  begin
...
class operator TdDouble4D.Multiply(const A_: TdDouble; const B_: TdDouble4D)
  : TdDouble4D;
begin
  with Result do
  begin
...
class operator TdDouble4D.Divide(const A_: TdDouble4D; const B_: TdDouble)
  : TdDouble4D;
begin
  with Result do
  begin
...
begin
  Result := A_.X * B_.X + A_.Y * B_.Y + A_.Z * B_.Z + A_.W * B_.W;
end;
...
begin
  with Result do
  begin
    X := A_.Y * B_.Z * C_.W - A_.W * B_.Z * C_.Y + B_.Y * C_.Z * A_.W - B_.W *
      C_.Z * A_.Y + C_.Y * A_.Z * B_.W - C_.W * A_.Z * B_.Y;

    Y := A_.X * B_.W * C_.Z - A_.Z * B_.W * C_.X + B_.X * C_.W * A_.Z - B_.Z *
      C_.W * A_.X + C_.X * A_.W * B_.Z - C_.Z * A_.W * B_.X;

    Z := A_.W * B_.X * C_.Y - A_.Y * B_.X * C_.W + B_.W * C_.X * A_.Y - B_.Y *
      C_.X * A_.W + C_.W * A_.X * B_.Y - C_.Y * A_.X * B_.W;

    W := A_.Z * B_.Y * C_.X - A_.X * B_.Y * C_.Z + B_.Z * C_.Y * A_.X - B_.X *
      C_.Y * A_.Z + C_.Z * A_.Y * B_.X - C_.X * A_.Y * B_.Z;
  end;
end;

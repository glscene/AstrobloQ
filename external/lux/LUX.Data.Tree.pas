...
type
  ...
  ITreeNode = interface(ITreeItem)
    ...
    property Childs[const I_: Integer]: ITreeNode read GetChilds
...
begin
  ...
  while Assigned(Result.Paren) do
    Result := Result.Paren as TTreeNode;
end;
...
begin
  Swap(Childs[I1_] as TTreeNode, Childs[I2_] as TTreeNode);
end;

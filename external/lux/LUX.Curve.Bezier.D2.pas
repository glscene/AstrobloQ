...
function Bezier4(const Ps_: TdSingleM4; const T_: TdSingle2D)
  : TdSingle; overload;
function Bezier4(const Ps_: TdDoubleM4; const T_: TdDouble2D)
  : TdDouble; overload;

function Bezier4(const Ps_: TSingle4x4x2D; const T_: TSingle2D)
  : TSingle2D; overload;
function Bezier4(const Ps_: TDouble4x4x2D; const T_: TDouble2D)
  : TDouble2D; overload;
function Bezier4(const Ps_: TdSingle4x4x2D; const T_: TdSingle2D)
  : TdSingle2D; overload;
function Bezier4(const Ps_: TdDouble4x4x2D; const T_: TdDouble2D)
  : TdDouble2D; overload;

function Bezier4(const Ps_: TSingle4x4x3D; const T_: TSingle2D)
  : TSingle3D; overload;
function Bezier4(const Ps_: TDouble4x4x3D; const T_: TDouble2D)
  : TDouble3D; overload;
function Bezier4(const Ps_: TdSingle4x4x3D; const T_: TdSingle2D)
  : TdSingle3D; overload;
function Bezier4(const Ps_: TdDouble4x4x3D; const T_: TdDouble2D)
  : TdDouble3D; overload;

function TensorBezier4(const Ps_: TSingle4x4x3D; const T_: TSingle2D)
  : TSingleM4; overload;
function TensorBezier4(const Ps_: TDouble4x4x3D; const T_: TDouble2D)
  : TDoubleM4; overload;

...
type
  ...
  public
    ...
    property Brics[const X_, Y_, Z_: Integer]: Boolean read GetBrics
      write SetBrics;
...
begin
  if (0 <= Z_) and (Z_ < _BricsZ) and (0 <= Y_) and (Y_ < _BricsY) and (0 <= X_)
    and (X_ < _BricsX) then
    Result := _Brics[Z_, Y_, X_]
  else
    Result := False;
end;
...
begin
  Context.SetMatrix(TMatrix3D.CreateTranslation(TPoint3D.Create(-_BricsX / 2,
    -_BricsY / 2, -_BricsZ / 2)) * TMatrix3D.CreateScaling
    (TPoint3D.Create(Width / _BricsX, Height / _BricsY, Depth / _BricsZ)) *
    AbsoluteMatrix);

  Context.DrawTriangles(_Geometry.VertexBuffer, _Geometry.IndexBuffer,
    TMaterialSource.ValidMaterial(_Material), AbsoluteOpacity);
end;
...
const
  Quads: array [1 .. 6] of TQuad = ((N: (X: - 1; Y: 0; Z: 0);
    P1: (X: 0; Y: 0; Z: 0); P2: (X: 0; Y: 1; Z: 0); P3: (X: 0; Y: 1; Z: 1);
    P4: (X: 0; Y: 0; Z: 1)), (N: (X: 0; Y: - 1; Z: 0); P1: (X: 0; Y: 0; Z: 0);
    P2: (X: 0; Y: 0; Z: 1); P3: (X: 1; Y: 0; Z: 1); P4: (X: 1; Y: 0; Z: 0)),
    (N: (X: 0; Y: 0; Z: - 1); P1: (X: 0; Y: 0; Z: 0); P2: (X: 1; Y: 0; Z: 0);
    P3: (X: 1; Y: 1; Z: 0); P4: (X: 0; Y: 1; Z: 0)), (N: (X: + 1; Y: 0; Z: 0);
    P1: (X: 1; Y: 1; Z: 1); P2: (X: 1; Y: 1; Z: 0); P3: (X: 1; Y: 0; Z: 0);
    P4: (X: 1; Y: 0; Z: 1)), (N: (X: 0; Y: + 1; Z: 0); P1: (X: 1; Y: 1; Z: 1);
    P2: (X: 0; Y: 1; Z: 1); P3: (X: 0; Y: 1; Z: 0); P4: (X: 1; Y: 1; Z: 0)),
    (N: (X: 0; Y: 0; Z: + 1); P1: (X: 1; Y: 1; Z: 1); P2: (X: 1; Y: 0; Z: 1);
    P3: (X: 0; Y: 0; Z: 1); P4: (X: 0; Y: 1; Z: 1)));
  // |/       |/
  // 011------111--
  // /|       /|
  // |/ |     |/ |

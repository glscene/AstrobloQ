...
type
  ...
  public
    ...
    property MargsX: Integer read GetMargsX write SetMargsX;
    property ItemsN: Integer read GetItemsN;
    property Items[const X_: Integer]: _TItem_ read GetItems
  ...
  public
    property Cells[const X_: Integer]: _TItem_ read GetItems
      write SetItems; default;
    property CellsX: Integer read GetItemsX write SetItemsX;
    property PoinsX: Integer read GetPoinsX write SetPoinsX;
  ...
  public
    ...
    destructor Destroy; override;
    property Poins[const X_: Integer]: _TItem_ read GetItems
      write SetItems; default;
    property PoinsX: Integer read GetItemsX write SetItemsX;
    property CellsX: Integer read GetCellsX write SetCellsX;
    procedure MakeEdgePerio; override;
  ...
  protected
    ...
    function Interp(const G0_, G1_, G2_, G3_: _TItem_; const Id_: Single)
      : _TItem_; overload; virtual; abstract;
    function InterpPos(const G0_, G1_, G2_, G3_: TPosval1D<_TItem_>;
      const Pos_: Single): _TItem_; overload; virtual; abstract;
  public
    ...
    function AddTail(const Pos_: Single; const Val_: _TItem_): Integer;
      overload;
    function Insert(const PV_: TPosval1D<_TItem_>): Integer; overload; virtual;
    function Insert(const Pos_: Single; const Val_: _TItem_): Integer;
      overload; virtual;
  end;
...
begin
  inherited Create(CellsX_ + 1, MargsX_);
...
function TIrreMap1D<_TItem_>.AddTail(const Pos_: Single;
  const Val_: _TItem_): Integer;
begin
...
function TIrreMap1D<_TItem_>.Insert(const Pos_: Single;
  const Val_: _TItem_): Integer;
begin

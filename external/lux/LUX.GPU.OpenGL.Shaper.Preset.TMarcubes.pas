...
begin
  ...
  begin
    ...
    ShaderV.LoadFromResource
      ('TMarcubes.Faces_V.glsl');
    ShaderG.LoadFromResource
      ('TMarcubes_Faces_G_glsl');
    ShaderF.LoadFromResource
      ('TMarcubes_FacesRGB_F_glsl');
  end;
...
begin
  ...
  begin
    ...
    ShaderV.LoadFromResource
      ('LUX_GPU_OpenGL_Shaper_Preset_TMarcubes_Faces_V_glsl');
    ShaderG.LoadFromResource
      ('LUX_GPU_OpenGL_Shaper_Preset_TMarcubes_Faces_G_glsl');
    ShaderF.LoadFromResource
      ('LUX_GPU_OpenGL_Shaper_Preset_TMarcubes_FacesMIR_F_glsl');
  end;
...
begin
  ...
  begin
    ...
    ShaderV.LoadFromResource
      ('LUX_GPU_OpenGL_Shaper_Preset_TMarcubes_Cubes_V_glsl');
    ShaderG.LoadFromResource
      ('LUX_GPU_OpenGL_Shaper_Preset_TMarcubes_Cubes_G_glsl');
    ShaderF.LoadFromResource
      ('LUX_GPU_OpenGL_Shaper_Preset_TMarcubes_Cubes_F_glsl');
  end;
end;

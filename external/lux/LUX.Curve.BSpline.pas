...
function BSpline(const T_: Single; const I0, N1: Integer;
  const Ts_: array of Single): Single; overload;
function BSpline(const T_: Double; const I0, N1: Integer;
  const Ts_: array of Double): Double; overload;
function BSpline(const T_: TdSingle; const I0, N1: Integer;
  const Ts_: array of TdSingle): TdSingle; overload;
function BSpline(const T_: TdDouble; const I0, N1: Integer;
  const Ts_: array of TdDouble): TdDouble; overload;
...
function BSpline3(const P0_, P1_, P2_, P3_: Single; const T_: Single)
  : Single; overload;
function BSpline3(const P0_, P1_, P2_, P3_: Double; const T_: Double)
  : Double; overload;
function BSpline3(const P0_, P1_, P2_, P3_: TdSingle; const T_: TdSingle)
  : TdSingle; overload;
function BSpline3(const P0_, P1_, P2_, P3_: TdDouble; const T_: TdDouble)
  : TdDouble; overload;

function BSpline4(const P0_, P1_, P2_, P3_: Single; const T_: Single)
  : Single; overload;
function BSpline4(const P0_, P1_, P2_, P3_: Double; const T_: Double)
  : Double; overload;
function BSpline4(const P0_, P1_, P2_, P3_: TdSingle; const T_: TdSingle)
  : TdSingle; overload;
function BSpline4(const P0_, P1_, P2_, P3_: TdDouble; const T_: TdDouble)
  : TdDouble; overload;
...
begin
  SetLength(_Poins, PoinMaxI - PoinMinI + 1);
  upPoins := True;
...
begin
  ...
  Result := BSpline4(Verts[Xi - 1], Verts[Xi], Verts[Xi + 1],
    Verts[Xi + 2], Xd);
end;
...
function BSpline(const T_: Single; const I0, N1: Integer;
  const Ts_: array of Single): Single;
var
  I1, N0: Integer;
  T0, T1, T2, T3: Single;
begin
  ...
  begin
    ...
    if T2 > T0 then
      Result := Result + (T_ - T0) / (T2 - T0) * BSpline(T_, I0, N0, Ts_);
    if T3 > T1 then
      Result := Result + (T3 - T_) / (T3 - T1) * BSpline(T_, I1, N0, Ts_);
  end;
end;

function BSpline(const T_: Double; const I0, N1: Integer;
  const Ts_: array of Double): Double;
var
  I1, N0: Integer;
  T0, T1, T2, T3: Double;
begin
...
function BSpline(const T_: TdSingle; const I0, N1: Integer;
  const Ts_: array of TdSingle): TdSingle;
var
  I1, N0: Integer;
...
function BSpline(const T_: TdDouble; const I0, N1: Integer;
  const Ts_: array of TdDouble): TdDouble;
var
  I1, N0: Integer;
...
begin
  ...
  if X < 1 then
    Result := (0.5 * X - 1) * X * X + C
  else if X < 2 then
    Result := ((1 - A * X) * X - 2) * X + B
  else
    Result := 0;
end;
...
begin
  ...
  Result := Ws._1 * P0_ + Ws._2 * P1_ + Ws._3 * P2_ + Ws._4 * P3_;
end;

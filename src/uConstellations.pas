unit uConstellations;

//--------------------------------------------------
// Constellation lines and names, version 2001-10-21
//--------------------------------------------------
(*
...
const
  // constellation lines and bayer letters
  Constellation_length = 602;
  Constellation: array[0..Constellation_length] of TConst_star =
...
(*
 Constellation positions of centers, for name see Constname
 RA * 1000, Dec * 100
*)

...
procedure TFormPhotonjet.FormCreate(Sender: TObject);
begin
...
procedure TFormPhotonjet.GLCadencer1Progress(Sender: TObject;
  const deltaTime, newTime: Double);
var
  i: Integer;
  f, a, ab, ca, sa: Single;
...
procedure TFormPhotonjet.GLSceneViewer1MouseDown(Sender: TObject;
...
procedure TFormPhotonjet.GLSceneViewer1MouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
begin
  if Shift <> [] then
  begin

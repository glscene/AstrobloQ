...
begin
  ...
  dcViewing.Turn(90);
  // Ќачальное смещение высоты камеры (контролируетс€ клавишами pgUp/pgDown)
  FCamHeight := 20;
  // небосвод с мигающими звЄздами
  with SkyDome1 do
  begin
...
var
  speed: Single;
begin
  // обработка нажати€ клавиш навигации
  (*
  if IsKeyDown(VK_SHIFT) then
    speed := 300*deltaTime
  else *)
    speed := 50 * deltaTime;  // скорость полЄта
  // полЄт над террейной со скоростью speed
  ...
  *)
  ...
  if IsKeyDown(VK_ESCAPE) then
    FormCrafts.Close; // закрыть главную форму приложени€
end;

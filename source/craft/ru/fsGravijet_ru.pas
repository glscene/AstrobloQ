...
//-----------------------------------------------------------------------------
procedure TFormGravijet.FormCreate(Sender: TObject);
begin
...
//-----------------------------------------------------------------------------
procedure TFormGravijet.RadioGroup1Click(Sender: TObject);
begin
...
//-----------------------------------------------------------------------------
procedure TFormGravijet.Sphere1Progress(Sender: TObject;
  const deltaTime, newTime: Double);
begin
...
//-----------------------------------------------------------------------------
procedure TFormGravijet.CheckBox1Click(Sender: TObject);
begin
...
//-----------------------------------------------------------------------------
procedure TFormGravijet.ComboBox1Change(Sender: TObject);
begin
...
//-----------------------------------------------------------------------------
procedure TFormGravijet.CheckBox2Click(Sender: TObject);
begin
  GLLightSource1.Shining := CheckBox2.Checked;
end;

//-----------------------------------------------------------------------------
procedure TFormGravijet.TrackBar1Change(Sender: TObject);
begin
  // adjust X extents
...
//-----------------------------------------------------------------------------
procedure TFormGravijet.TrackBar2Change(Sender: TObject);
begin
  // adjust Y extents
...
//-----------------------------------------------------------------------------
procedure TFormGravijet.TrackBar3Change(Sender: TObject);
begin
...
//-----------------------------------------------------------------------------
procedure TFormGravijet.Timer1Timer(Sender: TObject);
begin
...
//-----------------------------------------------------------------------------
procedure TFormGravijet.GLSceneViewer1MouseDown(Sender: TObject;
...
//-----------------------------------------------------------------------------
procedure TFormGravijet.GLSceneViewer1MouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
begin
  if Shift <> [] then
  begin
...
//-----------------------------------------------------------------------------
procedure TFormGravijet.FormMouseWheel(Sender: TObject; Shift: TShiftState;
  WheelDelta: Integer; MousePos: TPoint; var Handled: Boolean);
begin

...
procedure TFormGLSViewer.ACExitExecute(Sender: TObject);
begin
  Close;
end;
...
begin
  ACFPS.Checked := False;
  ApplyFPS;
  FormGLSViewerY := FormGLSViewer.top;
  FormGLSViewerX := FormGLSViewer.left;
end;
...
procedure TFormGLSViewer.GLSceneViewerBeforeRender(Sender: TObject);
begin
...
procedure TFormGLSViewer.GLSceneViewerAfterRender(Sender: TObject);
begin
  ApplyFSAA;
  Screen.Cursor := crDefault;
end;

procedure TFormGLSViewer.MIAboutClick(Sender: TObject);
begin
  Application.HelpContext(4000);
end;

procedure TFormGLSViewer.About1Click(Sender: TObject);
begin
...
procedure TFormGLSViewer.ACOpenExecute(Sender: TObject);
begin
...
procedure TFormGLSViewer.GLSceneViewerMouseDown(Sender: TObject;
...
procedure TFormGLSViewer.GLSceneViewerMouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
var
  d: Single;
begin
...
procedure TFormGLSViewer.GLSceneViewerMouseUp(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
  md := False;
end;
...
procedure TFormGLSViewer.ACZoomInExecute(Sender: TObject);
var
  h: Boolean;
begin
...
procedure TFormGLSViewer.ACZoomOutExecute(Sender: TObject);
var
  h: Boolean;
begin
  FormMouseWheel(Self, [], 120 * 4, Point(0, 0), h);
...
procedure TFormGLSViewer.ACShadeSmoothExecute(Sender: TObject);
begin
  ApplyShadeMode;
end;

procedure TFormGLSViewer.AllBtnsUp;
Begin
...
procedure TFormGLSViewer.Smoothshading1Click(Sender: TObject);
begin
  AllBtnsUp;
...
procedure TFormGLSViewer.Flatshading1Click(Sender: TObject);
begin
  AllBtnsUp;
...
procedure TFormGLSViewer.FlatShadingwithlines1Click(Sender: TObject);
begin
  AllBtnsUp;
...
procedure TFormGLSViewer.Hiddenlines1Click(Sender: TObject);
begin
  AllBtnsUp;
...
procedure TFormGLSViewer.Wireframe1Click(Sender: TObject);
begin
  AllBtnsUp;
...
procedure TFormGLSViewer.MIAADefaultClick(Sender: TObject);
begin
  (Sender as TMenuItem).Checked := True;
  ApplyFSAA;
end;

procedure TFormGLSViewer.ACResetViewExecute(Sender: TObject);
begin
  DoResetCamera;
end;

procedure TFormGLSViewer.ACCullFaceExecute(Sender: TObject);
begin
  ACCullFace.Checked := not ACCullFace.Checked;
  ApplyFaceCull;
end;

procedure TFormGLSViewer.MIBgColorClick(Sender: TObject);
begin
  if ColorDialog.Execute then
    ApplyBgColor;
end;

procedure TFormGLSViewer.GLMaterialLibraryTextureNeeded(Sender: TObject;
  var textureFileName: String);
begin
...
procedure TFormGLSViewer.ACTexturingExecute(Sender: TObject);
begin
...
procedure TFormGLSViewer.MIFileClick(Sender: TObject);
begin
  MIPickTexture.Enabled := (GLMaterialLibrary.Materials.Count > 0);
end;

procedure TFormGLSViewer.MIPickTextureClick(Sender: TObject);
begin
...
procedure TFormGLSViewer.MIOpenTexLibClick(Sender: TObject);
var
  i: Integer;
begin
...
procedure TFormGLSViewer.ACSaveAsExecute(Sender: TObject);
var
  ext: String;
begin
...
procedure TFormGLSViewer.GLCadencerProgress(Sender: TObject;
  const deltaTime, newTime: Double);
begin
  GLSceneViewer.Invalidate;
end;

procedure TFormGLSViewer.ACFPSExecute(Sender: TObject);
begin
...
procedure TFormGLSViewer.ACSaveTexturesExecute(Sender: TObject);
begin
...
procedure TFormGLSViewer.LightMapMaker1Click(Sender: TObject);
begin
  { }
end;

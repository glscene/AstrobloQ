...
//----------------------------------------------------------------------
function TForm1.ReconstructPath(Current: TStarNode): TArray<TGSVector>;
var
...
(*
алгоритм некоторые немаловажные шаги, хотя их наверняка можно включить в методы поиска кратчайшего пути Дейкстры или А* 3d.
Итак:

...
uses
  ...
  GLS.Graph,
  GLS.SmoothNavigator,
  GLS.Screen, GLS.Navigator;

type
  TfrmNavigator = class(TForm)
    GLScene1: TGLScene;
...
//----------------------------------------------------------------------------
procedure TfrmNavigator.FormCreate(Sender: TObject);
begin
...
//----------------------------------------------------------------------------
procedure TfrmNavigator.CheckControls(DeltaTime, newtime: Double);
var
...
//----------------------------------------------------------------------------
procedure TfrmNavigator.GLCadencer1Progress(Sender: TObject; const DeltaTime, newTime: Double);
begin
...
//----------------------------------------------------------------------------
procedure TfrmNavigator.FPSTimerTimer(Sender: TObject);
begin
...
//----------------------------------------------------------------------------
procedure TfrmNavigator.MouseLookCheckBoxClick(Sender: TObject);
begin
...
//----------------------------------------------------------------------------
procedure TfrmNavigator.FormKeyPress(Sender: TObject; var Key: Char);
begin
...
//----------------------------------------------------------------------------
procedure TfrmNavigator.FormClose(Sender: TObject; var Action: TCloseAction);
begin
...
//----------------------------------------------------------------------------
procedure TfrmNavigator.RadioButton6Click(Sender: TObject);
begin
  GLCadencer1.FixedDeltaTime := 0;
end;

//----------------------------------------------------------------------------
procedure TfrmNavigator.RadioButton7Click(Sender: TObject);
begin
  GLCadencer1.FixedDeltaTime := 0.01;
end;

//----------------------------------------------------------------------------
procedure TfrmNavigator.RadioButton8Click(Sender: TObject);
begin
  GLCadencer1.FixedDeltaTime := 0.1;
end;

//----------------------------------------------------------------------------
procedure TfrmNavigator.GLSceneViewer1MouseMove(Sender: TObject;
...
//----------------------------------------------------------------------------
procedure TfrmNavigator.GLSceneViewer1MouseDown(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
  xx := x;
  yy := y;
...
//----------------------------------------------------------------------------
procedure TfrmNavigator.FormMouseWheel(Sender: TObject; Shift: TShiftState;
  WheelDelta: Integer; MousePos: TPoint; var Handled: Boolean);
begin

...
begin
  ...
  begin
    case MessageDlg('Текущие данные были изменены.'+
              #13#10'Для сохранения изменений нажмите Apply Change Button.'+
...
begin
  ...
  1:case InputRG.ItemIndex of
    0:Text := 'Enter a value for polar angle ''Ш'' then press Enter key.';
    1:Text := 'Enter a value then press Enter key to alter ''Ш''.';
    2:Text := 'Select an item from the coordinates list and press Delete Key.';
    end;
...
begin
  ...
  begin
    ...
    1:begin
        Label2.Caption := 'Plot Polar Coordinates {Ш, r}';
      end;
    2:begin

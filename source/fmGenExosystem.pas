...
type
 ...
 // TGLSprite = class (TGLSceneObject);
  ...
  private
    FExtraData: TGLMoonRingData;
  public
    property ExtraData: TGLMoonRingData read FExtraData write FExtraData;
  end;
  ...
  private
    FExtraData: TGLAsteroidData;
  public
    property ExtraData: TGLAsteroidData read FExtraData write FExtraData;
  end;
...
var
  FrmGenPlanetsys: TFrmGenPlanetsys;
...
procedure TFrmGenPlanetsys.FormCreate(Sender: TObject);
begin
  { top := ABCreatorFormY;
    left := ABCreatorFormX; }
...
procedure TFrmGenPlanetsys.FormShow(Sender: TObject);
begin
  dmx := 1;
...
procedure TFrmGenPlanetsys.FormClose(Sender: TObject; var Action: TCloseAction);
var
  j: Integer;
begin
...
procedure TFrmGenPlanetsys.ExitBtnClick(Sender: TObject);
begin
  Close;
end;

procedure TFrmGenPlanetsys.HelpBtnClick(Sender: TObject);
begin
  Application.HelpContext(2000);
end;

procedure TFrmGenPlanetsys.ClearBtnClick(Sender: TObject);
var
  j: Integer;
begin
...
procedure TFrmGenPlanetsys.ClearData;
var
  DCCenter: TGLBaseSceneObject;
begin
  DCSolarSystem.DeleteChildren;
  GLMaterialLibraryA.Materials.Clear;
  SystemDataTmp.NbStar := 1;
  ...
  SunDataTmp.StarSysScale := 12756;
  SunDataTmp.StarDistanceScale := 10000;
  SolarScaleDivisor := 12756;
  SolarDistance := 10000;
  DCCenter := TGLDummyCube.Create(self);
  DCCenter.Name := 'DC' + SunDataTmp.StarName;
...
procedure TFrmGenPlanetsys.ClearDataEdits;
begin
  NameEdit.Text := 'Star';
...
//----------------------------------------------------------
procedure TFrmGenPlanetsys.LoadBtnClick(Sender: TObject);
begin
//  SetCurrentDir(Application.ExeName);
  ...
  begin
    FrmGenPlanetsys.Caption := 'Загрузка';
...
procedure TFrmGenPlanetsys.CreateGLSolarSystem(filename: string);
var
...
begin
  ...
  // Clear from all children objects dcSolarSystem
  DCSolarSystem.DeleteChildren;
  for j := dcComet.Count - 1 downto 1 do
  begin
    dcComet.Children[j].Visible := False;
  ...
  *)
  BlockRead(F, SystemDataTmp, sizeof(TGLStarSysData));
  // Set Arrays
  ...
  begin // FFS3ds          : TGLFreeForm;
    BlockRead(F, S3dsDataTmpArray[0, 0, j], sizeof(TGLMoonRingData));
    DCCenter := TGLDummyCube.Create(self);
  ...
  begin
    // ------- Planet ----------------
    BlockRead(F, PlanetDataTmpArray[i], sizeof(TGLPlanetData));
    DCCenter := TGLDummyCube.Create(self);
    ...
    begin
      BlockRead(F, RingDataTmpArray[i, j], sizeof(TGLMoonRingData));
      DCCenter := TGLDummyCube.Create(self);
    ...
    begin
      BlockRead(F, MoonDataTmpArray[i, j], sizeof(TGLMoonRingData));
      DCCenter := TGLDummyCube.Create(self);
    ...
    begin { FFS3ds          : TGLFreeForm; }
      ...
      begin
        ShowMessage(S3dsDataTmpArray[1, i, j].Name + '.3ds' + ' not found');
        Closefile(F);
        GLSceneA.EndUpdate;
        exit;
      End;
  ...
  begin
    // ------- Asteroids ----------------
    BlockRead(F, AsteroidDataTmpArray[i], sizeof(TGLAsteroidData));
    DCCenter := TGLDummyCube.Create(self);
    ...
    begin // FFS3ds          : TGLFreeForm;
      BlockRead(F, S3dsDataTmpArray[2, i, j], sizeof(TGLMoonRingData));
      DCCenter := TGLDummyCube.Create(self);
      ...
      begin
        ShowMessage(S3dsDataTmpArray[2, i, j].Name + '.3ds' + ' not found');
        Closefile(F);
        GLSceneA.EndUpdate;
        exit;
      End;
  ...
  begin
    ...
    BlockRead(F, CometDataTmpArray[i], sizeof(TGLAsteroidData));
    DCCenter := TGLDummyCube.Create(self);
    ...
    begin { FFS3ds          : TGLFreeForm; }
      BlockRead(F, S3dsDataTmpArray[3, i, j], sizeof(TGLMoonRingData));
      DCCenter := TGLDummyCube.Create(self);
      ...
      begin
        ShowMessage(S3dsDataTmpArray[3, i, j].Name + '.3ds' + ' not found');
        Closefile(F);
        GLSceneA.EndUpdate;
        Exit();
      end;
  ...
  begin
    ...
    BlockRead(F, DebrisDataTmpArray[i], sizeof(TGLAsteroidData));
    DCCenter := TGLDummyCube.Create(self);
    ...
    begin // FFS3ds          : TGLFreeForm;
      BlockRead(F, S3dsDataTmpArray[4, i, j], sizeof(TGLMoonRingData));
      DCCenter := TGLDummyCube.Create(self);
...
(*
  ...
  ..\..\asset\Flare1.bmp ..flare.jpg has 'corona'
...
{ --------------------------------------------------- }
procedure TFrmGenPlanetsys.SaveBtnClick(Sender: TObject);
begin
...
procedure TFrmGenPlanetsys.SaveGLSolarSystem(filename: string);
var
  i, j: Integer;
  F: file;
begin
  ...
  Blockwrite(F, SystemDataTmp, sizeof(TGLStarSysData));

  Blockwrite(F, SunDataTmp, sizeof(TGLStarData));
  for j := 0 to SunDataTmp.nbS3ds - 1 do
    Blockwrite(F, S3dsDataTmpArray[0, 0, j], sizeof(TGLMoonRingData));
  for i := 0 to SystemDataTmp.NbPlanet - 1 do
  begin
    Blockwrite(F, PlanetDataTmpArray[i], sizeof(TGLPlanetData));
    for j := 0 to PlanetDataTmpArray[i].nbRings - 1 do
      Blockwrite(F, RingDataTmpArray[i, j], sizeof(TGLMoonRingData));
    for j := 0 to PlanetDataTmpArray[i].nbMoons - 1 do
      Blockwrite(F, MoonDataTmpArray[i, j], sizeof(TGLMoonRingData));
    for j := 0 to PlanetDataTmpArray[i].nbS3ds - 1 do
      Blockwrite(F, S3dsDataTmpArray[1, i, j], sizeof(TGLMoonRingData));
  end;

  for i := 0 to SystemDataTmp.NbAsteroid - 1 do
  begin
    Blockwrite(F, AsteroidDataTmpArray[i], sizeof(TGLAsteroidData));
    for j := 0 to AsteroidDataTmpArray[i].nbS3ds - 1 do
      Blockwrite(F, S3dsDataTmpArray[2, i, j], sizeof(TGLMoonRingData));
  end;
  for i := 0 to SystemDataTmp.NbComet - 1 do
  begin
    Blockwrite(F, CometDataTmpArray[i], sizeof(TGLAsteroidData));
    for j := 0 to CometDataTmpArray[i].nbS3ds - 1 do
      Blockwrite(F, S3dsDataTmpArray[3, i, j], sizeof(TGLMoonRingData));
  end;
  for i := 0 to SystemDataTmp.NbDebris - 1 do
  begin
    Blockwrite(F, DebrisDataTmpArray[i], sizeof(TGLAsteroidData));
    for j := 0 to DebrisDataTmpArray[i].nbS3ds - 1 do
      Blockwrite(F, S3dsDataTmpArray[4, i, j], sizeof(TGLMoonRingData));
  end;
  Closefile(F);
end;

procedure TFrmGenPlanetsys.PlanetsRGClick(Sender: TObject);
var
  tempbool: Boolean;
begin
  // only sun has scale
  ...
  // base objects have S3ds orbiters
  ...
  // Sun don't has orbit but has S3ds
  OrbitGroupBox.Visible := ((SSORG.ItemIndex > 0) or ((SSORG.ItemIndex = 0) and
    (SunRG.ItemIndex = 1)));
  // show planets, moons and rings only
  ...
  // Only comets, debries and planets: Rings REQUIRE more data
...
//------------------------------------------------------------
//
procedure TFrmGenPlanetsys.StoreBtnClick(Sender: TObject);
begin
  // GLCadencer1.Enabled:=False;
  case SSORG.ItemIndex of
    0:
      case SunRG.ItemIndex of
        0:
          begin
            SunDataTmp.StarName := (NameEdit.Text);
            ...
            SunDataTmp.StarSysScale := strtofloat(ScaleObjectEdit.Text);
            SunDataTmp.StarDistanceScale :=
              strtofloat(ScaleDistanceEdit.Text);

            SystemDataTmp.NbStar := 1; // Waiting to do Dual Star Systems...
      ...
      case PlanetsRG.ItemIndex of
        ...
        1:
          begin // RingDataTmpArray     : Array of Array of  TRingData;
            ...
            RingDataTmpArray[PlanetUpDown.Position - 1,
              RingsUpDown.Position - 1].mAnomalyVar := strtofloat(MVarEdit.Text);
        ...
        2:
          begin // MoonDataTmpArray: Array of Array of  TMoonData;
            ...
            MoonDataTmpArray[PlanetUpDown.Position - 1,
              MoonsUpDown.Position - 1].ObjectRotation := strtofloat(ObjectRotationEdit.Text);
            MoonDataTmpArray[PlanetUpDown.Position - 1,
              MoonsUpDown.Position - 1].AxisTilt := strtofloat(AxisTiltEdit.Text);
            MoonDataTmpArray[PlanetUpDown.Position - 1,
            ...
            MoonDataTmpArray[PlanetUpDown.Position - 1,
              ...
              strtofloat(RCDZSizeEdit.Text);
            MoonDataTmpArray[PlanetUpDown.Position - 1,
              MoonsUpDown.Position - 1].RCDPosition := strtofloat(RCDPositionEdit.Text);

            MoonDataTmpArray[PlanetUpDown.Position - 1,
              MoonsUpDown.Position - 1].Albedo := strtofloat(AlbedoEdit.Text);
            MoonDataTmpArray[PlanetUpDown.Position - 1,
              MoonsUpDown.Position - 1].OrbitRotation := strtofloat(OrbitRotationEdit.Text);
            MoonDataTmpArray[PlanetUpDown.Position - 1,
              MoonsUpDown.Position - 1].aDistance := strtofloat(aConstEdit.Text);
            MoonDataTmpArray[PlanetUpDown.Position - 1,
              MoonsUpDown.Position - 1].aDistanceVar := strtofloat(aVarEdit.Text);
            MoonDataTmpArray[PlanetUpDown.Position - 1,
              MoonsUpDown.Position - 1].Inclination := strtofloat(iConstEdit.Text);
            MoonDataTmpArray[PlanetUpDown.Position - 1,
              MoonsUpDown.Position - 1].InclinationVar := strtofloat(iVarEdit.Text);
            MoonDataTmpArray[PlanetUpDown.Position - 1,
              MoonsUpDown.Position - 1].Eccentricity := strtofloat(eConstEdit.Text);
            MoonDataTmpArray[PlanetUpDown.Position - 1,
              MoonsUpDown.Position - 1].EVar := strtofloat(eVarEdit.Text);
            MoonDataTmpArray[PlanetUpDown.Position - 1,
              MoonsUpDown.Position - 1].EMax := strtofloat(EMaxEdit.Text);
            MoonDataTmpArray[PlanetUpDown.Position - 1,
              MoonsUpDown.Position - 1].nLongitude := strtofloat(NConstEdit.Text);
            MoonDataTmpArray[PlanetUpDown.Position - 1,
              MoonsUpDown.Position - 1].nLongitudeVar := strtofloat(NVarEdit.Text);
            MoonDataTmpArray[PlanetUpDown.Position - 1,
              MoonsUpDown.Position - 1].wPerihelion := strtofloat(wConstEdit.Text);
            MoonDataTmpArray[PlanetUpDown.Position - 1,
              MoonsUpDown.Position - 1].wPerihelionVar := strtofloat(wVarEdit.Text);
            MoonDataTmpArray[PlanetUpDown.Position - 1,
              MoonsUpDown.Position - 1].mAnomaly := strtofloat(MConstEdit.Text);
            MoonDataTmpArray[PlanetUpDown.Position - 1,
              MoonsUpDown.Position - 1].mAnomalyVar := strtofloat(MVarEdit.Text);
            MoonDataTmpArray[PlanetUpDown.Position - 1,
              MoonsUpDown.Position - 1].VelocityType := strtoint(VelocityTypeEdit.Text);
            MoonDataTmpArray[PlanetUpDown.Position - 1,
              MoonsUpDown.Position - 1].Velocity := strtofloat(VelocityEdit.Text);
            MoonDataTmpArray[PlanetUpDown.Position - 1,
              MoonsUpDown.Position - 1].VelocityDir := strtofloat(VelocityDirEdit.Text);
            MoonDataTmpArray[PlanetUpDown.Position - 1,
        ...
        3:
          begin // S3dsDataTmpArray     :Array of Array of Array of  TMoonData;
            ...
            S3dsDataTmpArray[1, PlanetUpDown.Position - 1,
              PS3dsUpDown.Position - 1].RCDXYSize := strtofloat(RCDXYSizeEdit.Text);
            S3dsDataTmpArray[1, PlanetUpDown.Position - 1,
              PS3dsUpDown.Position - 1].RCDZSize := strtofloat(RCDZSizeEdit.Text);
            S3dsDataTmpArray[1, PlanetUpDown.Position - 1,
              PS3dsUpDown.Position - 1].RCDPosition := strtofloat(RCDPositionEdit.Text);

            S3dsDataTmpArray[1, PlanetUpDown.Position - 1,
              PS3dsUpDown.Position - 1].Albedo := strtofloat(AlbedoEdit.Text);
            S3dsDataTmpArray[1, PlanetUpDown.Position - 1,
              PS3dsUpDown.Position - 1].OrbitRotation := strtofloat(OrbitRotationEdit.Text);

            S3dsDataTmpArray[1, PlanetUpDown.Position - 1,
              PS3dsUpDown.Position - 1].aDistance := strtofloat(aConstEdit.Text);
            S3dsDataTmpArray[1, PlanetUpDown.Position - 1,
              PS3dsUpDown.Position - 1].aDistanceVar := strtofloat(aVarEdit.Text);
            S3dsDataTmpArray[1, PlanetUpDown.Position - 1,
              PS3dsUpDown.Position - 1].Inclination := strtofloat(iConstEdit.Text);
            S3dsDataTmpArray[1, PlanetUpDown.Position - 1,
        ...
        1:
          begin // S3dsDataTmpArray     :Array of Array of Array of  TMoonData;
            ...
            S3dsDataTmpArray[3, CometUpDown.Position - 1,
              ...
              strtofloat(RCDZSizeEdit.Text);
            S3dsDataTmpArray[3, CometUpDown.Position - 1,
              CS3dsUpDown.Position - 1].RCDPosition := strtofloat(RCDPositionEdit.Text);

            S3dsDataTmpArray[3, CometUpDown.Position - 1,
              CS3dsUpDown.Position - 1].Albedo := strtofloat(AlbedoEdit.Text);
            S3dsDataTmpArray[3, CometUpDown.Position - 1,
              CS3dsUpDown.Position - 1].OrbitRotation := strtofloat(OrbitRotationEdit.Text);

            S3dsDataTmpArray[3, CometUpDown.Position - 1, CS3dsUpDown.Position - 1].aDistance :=
              strtofloat(aConstEdit.Text);
            S3dsDataTmpArray[3, CometUpDown.Position - 1, CS3dsUpDown.Position - 1].aDistanceVar :=
              strtofloat(aVarEdit.Text);
            S3dsDataTmpArray[3, CometUpDown.Position - 1, CS3dsUpDown.Position - 1].Inclination :=
              strtofloat(iConstEdit.Text);
            S3dsDataTmpArray[3, CometUpDown.Position - 1, CS3dsUpDown.Position - 1].InclinationVar
              := strtofloat(iVarEdit.Text);
            S3dsDataTmpArray[3, CometUpDown.Position - 1, CS3dsUpDown.Position - 1].Eccentricity :=
              strtofloat(eConstEdit.Text);
            S3dsDataTmpArray[3, CometUpDown.Position - 1, CS3dsUpDown.Position - 1].EVar :=
              strtofloat(eVarEdit.Text);
            S3dsDataTmpArray[3, CometUpDown.Position - 1, CS3dsUpDown.Position - 1].EMax :=
              strtofloat(EMaxEdit.Text);
            S3dsDataTmpArray[3, CometUpDown.Position - 1, CS3dsUpDown.Position - 1].nLongitude :=
              strtofloat(NConstEdit.Text);
            S3dsDataTmpArray[3, CometUpDown.Position - 1, CS3dsUpDown.Position - 1].nLongitudeVar :=
              strtofloat(NVarEdit.Text);
            S3dsDataTmpArray[3, CometUpDown.Position - 1, CS3dsUpDown.Position - 1].wPerihelion :=
              strtofloat(wConstEdit.Text);
            S3dsDataTmpArray[3, CometUpDown.Position - 1, CS3dsUpDown.Position - 1].wPerihelionVar
              := strtofloat(wVarEdit.Text);
            S3dsDataTmpArray[3, CometUpDown.Position - 1, CS3dsUpDown.Position - 1].mAnomaly :=
              strtofloat(MConstEdit.Text);
            S3dsDataTmpArray[3, CometUpDown.Position - 1, CS3dsUpDown.Position - 1].mAnomalyVar :=
              strtofloat(MVarEdit.Text);
            S3dsDataTmpArray[3, CometUpDown.Position - 1, CS3dsUpDown.Position - 1].VelocityType :=
              strtoint(VelocityTypeEdit.Text);
            S3dsDataTmpArray[3, CometUpDown.Position - 1, CS3dsUpDown.Position - 1].Velocity :=
              strtofloat(VelocityEdit.Text);
            S3dsDataTmpArray[3, CometUpDown.Position - 1, CS3dsUpDown.Position - 1].VelocityDir :=
              strtofloat(VelocityDirEdit.Text);
            S3dsDataTmpArray[3, CometUpDown.Position - 1, CS3dsUpDown.Position - 1].Atmosphere :=
              AtmosphereCB.ItemIndex;
          end;
      end;
    4:
...
procedure TFrmGenPlanetsys.ShowBtnClick(Sender: TObject);
      ...
      case SunRG.ItemIndex of
        0:
          begin
            ...
            ScaleObjectEdit.Text := Floattostr(SunDataTmp.StarSysScale);
            ScaleDistanceEdit.Text :=
              Floattostr(SunDataTmp.StarDistanceScale);
...
procedure TFrmGenPlanetsys.PrintBtnClick(Sender: TObject);
var
  i, j: Integer;
  F: TextFile;
begin
  ...
  rewrite(F);
  Writeln(F, 'System.NbSun: ' + Inttostr(SystemDataTmp.NbStar));
  ...
  Writeln(F, 'Sun.SunName: ' + (SunDataTmp.StarName));
  ...
  Writeln(F, 'Sun.SystemObjectScale: ' +
    Floattostr(SunDataTmp.StarSysScale));
...
procedure TFrmGenPlanetsys.PickActiveCBClick(Sender: TObject);
...
procedure TFrmGenPlanetsys.SunShineCBClick(Sender: TObject);
begin
  { If (PickActiveCB.Checked) then
    begin
    SunShineCB.Checked:=false;
...
procedure TFrmGenPlanetsys.GLSceneViewerABeforeRender(Sender: TObject);
begin
  If SunShineCB.Checked then
    SunShineFlare.PreRender(Sender as TGLSceneBuffer);
end;

procedure TFrmGenPlanetsys.SunShineTBChange(Sender: TObject);
begin
  SunShineFlare.Size := SunShineTB.Position;
  SunShineLabel.Caption := Inttostr(SunShineTB.Position);
end;

procedure TFrmGenPlanetsys.LabelTBChange(Sender: TObject);
var
  Temp: Double;
begin
...
procedure TFrmGenPlanetsys.S3dsScalerTBChange(Sender: TObject);
var
  Scale, i, j: Integer;
begin
...
procedure TFrmGenPlanetsys.TimeTrackBarChange(Sender: TObject);
begin
...
procedure TFrmGenPlanetsys.FormKeyPress(Sender: TObject; var Key: Char);
begin
  case Key of
    #27:
      Close;
...
procedure TFrmGenPlanetsys.PlanetPickerCBChange(Sender: TObject);
begin
...
procedure TFrmGenPlanetsys.RunBtnClick(Sender: TObject);
...
procedure TFrmGenPlanetsys.TimerATimer(Sender: TObject);
begin
...
procedure TFrmGenPlanetsys.StopBtnClick(Sender: TObject);
begin
  { GLCadencer1.Enabled:=False;
    Timer1.Enabled:=False; }
  Running := False;
...
procedure TFrmGenPlanetsys.GLCadencerAProgress(Sender: TObject;
  const deltaTime, newTime: Double);
var
...
procedure TFrmGenPlanetsys.AddToTrail(const p: TGLVector);
var
  i, k: Integer;
begin
...
procedure TFrmGenPlanetsys.GLSceneViewerAMouseDown(Sender: TObject;
...
procedure TFrmGenPlanetsys.DataDisplayer(Switch, Spec, Species, SubSpecies,
  Spec3ds: Integer);
var
  s1, s: String;
Begin
...
procedure TFrmGenPlanetsys.GLSceneViewerAMouseEnter(Sender: TObject);
begin
  GLSceneViewerA.SetFocus; // GLSceneViewer.Focused;
end;

procedure TFrmGenPlanetsys.GLSceneViewerAMouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
begin
...
procedure TFrmGenPlanetsys.CFLTrackBarChange(Sender: TObject);
begin
...
procedure TFrmGenPlanetsys.GLSceneViewerAMouseUp(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
  PickedObj := nil;
end;

procedure TFrmGenPlanetsys.FormMouseWheel(Sender: TObject; Shift: TShiftState;
  WheelDelta: Integer; MousePos: TPoint; var Handled: Boolean);
var
  F: Single;
...
procedure TFrmGenPlanetsys.CameraDistanceUpDownClick(Sender: TObject;
  Button: TUDBtnType);
var
  WheelDeltas: Integer;
  F: Single;
...
procedure TFrmGenPlanetsys.DisplayToolbar1Click(Sender: TObject);
begin
  DisplayToolbar1.Checked := (not DisplayToolbar1.Checked);
  ToggleToolbarDisplay;
end;

procedure TFrmGenPlanetsys.ToggleToolbarDisplay;
Begin
...
procedure TFrmGenPlanetsys.DisplayFPS1Click(Sender: TObject);
begin
...
procedure TFrmGenPlanetsys.FullScreen1Click(Sender: TObject);
...
procedure TFrmGenPlanetsys.GLSceneViewerADblClick(Sender: TObject);
begin
  FullScreen1Click(Sender);
end;

procedure TFrmGenPlanetsys.PlanetsLoadFakeTextureClick(Sender: TObject);
begin
  PlanetsLoadFakeTexture.Checked := (not PlanetsLoadFakeTexture.Checked);
end;

procedure TFrmGenPlanetsys.RingsLoadFakeTextureClick(Sender: TObject);
begin
  RingsLoadFakeTexture.Checked := (not RingsLoadFakeTexture.Checked);
end;

procedure TFrmGenPlanetsys.MoonsLoadFakeTextureClick(Sender: TObject);
begin
  MoonsLoadFakeTexture.Checked := (not MoonsLoadFakeTexture.Checked);
end;

procedure TFrmGenPlanetsys.S3dsLoadFakeTextureClick(Sender: TObject);
begin
  S3dsLoadFakeTexture.Checked := (not S3dsLoadFakeTexture.Checked);
end;

procedure TFrmGenPlanetsys.AsteroidsLoadFakeTextureClick(Sender: TObject);
begin
  AsteroidsLoadFakeTexture.Checked := (not AsteroidsLoadFakeTexture.Checked);
end;

procedure TFrmGenPlanetsys.CometsLoadFakeTextureClick(Sender: TObject);
begin
  CometsLoadFakeTexture.Checked := (not CometsLoadFakeTexture.Checked);
end;

procedure TFrmGenPlanetsys.DebrisLoadFakeTextureClick(Sender: TObject);
begin
  DebrisLoadFakeTexture.Checked := (not DebrisLoadFakeTexture.Checked);
end;

procedure TFrmGenPlanetsys.DocIndexLinkCBClick(Sender: TObject);
begin
  { DocIndexLinkCB.Checked := (not DocIndexLinkCB.Checked); }
end;

procedure TFrmGenPlanetsys.AtmosphereOnCBClick(Sender: TObject);
begin
  { Cant really 'Focus' on a Planet so Atmosphere is kinda a waste }
  { AtmosphereOnCB.Checked := (not AtmosphereOnCB.Checked); }
end;

procedure TFrmGenPlanetsys.UseOrbitalElementsCBClick(Sender: TObject);
begin
  { UseOrbitalElementsCB.Checked := (not UseOrbitalElementsCB.Checked); }

end;

procedure TFrmGenPlanetsys.LabelsOnCBClick(Sender: TObject);
begin { HUDLabel }
...
procedure TFrmGenPlanetsys.SelectFontMenuClick(Sender: TObject);
begin
...
procedure TFrmGenPlanetsys.OrbitTrailsOnCBClick(Sender: TObject);
var
  i: Integer;
...
procedure TFrmGenPlanetsys.DatePickerCBClick(Sender: TObject);
begin
  DateTimePicker1.Visible := (DatePickerCB.Checked);
end;

procedure TFrmGenPlanetsys.DateTimePicker1Change(Sender: TObject);
begin
  ShowMessage(Datetostr(DateTimePicker1.Date));
  OrbitalTime := DateTimePicker1.Date;
end;

procedure TFrmGenPlanetsys.MoonScalex0Click(Sender: TObject);
begin
  MoonScale := 0;
  Case MoonScale of
    0:
...
procedure TFrmGenPlanetsys.MoonScalex10Click(Sender: TObject);
begin
  MoonScale := 10;
  Case MoonScale of
    0:
...
procedure TFrmGenPlanetsys.MoonScalex50Click(Sender: TObject);
begin
  MoonScale := 50;
  Case MoonScale of
    0:
...
procedure TFrmGenPlanetsys.SunScale20Click(Sender: TObject);
begin
  SunScale := 20;
  Case SunScale of
    20:
...
procedure TFrmGenPlanetsys.SunScale200Click(Sender: TObject);
begin
  SunScale := 200;
  Case SunScale of
    20:
...
procedure TFrmGenPlanetsys.SunScale2000Click(Sender: TObject);
begin
  SunScale := 2000;
  Case SunScale of
    20:
...
procedure TFrmGenPlanetsys.OrbitTrails36Click(Sender: TObject);
begin
  MaxLines := 36;
  Case MaxLines of
    36:
...
procedure TFrmGenPlanetsys.OrbitTrails360Click(Sender: TObject);
begin
  MaxLines := 360;
  Case MaxLines of
    36:
...
procedure TFrmGenPlanetsys.OrbitTrails1000Click(Sender: TObject);
begin
  MaxLines := 1000;
  Case MaxLines of
    36:
...
procedure TFrmGenPlanetsys.OrbitTrails3600Click(Sender: TObject);
begin
  MaxLines := 3600;
  Case MaxLines of
    36:
...
procedure TFrmGenPlanetsys.SpudVersionConvertor1Click(Sender: TObject);
begin
  ///HoloSpudVCForm.Show;
end;

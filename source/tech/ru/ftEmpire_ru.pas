...
procedure TFormEmpire.FormCreate(Sender: TObject);
(* var
  reg : TRegistry;
  shellCmd : String;
  keyOkay : Boolean;
...
procedure TFormEmpire.ACExitExecute(Sender: TObject);
begin
  Close;
end;

procedure TFormEmpire.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  ACFPS.Checked := False;
  ApplyFPS;
  FormNoosferaY := FormEmpire.Top;
  FormNoosferaX := FormEmpire.Left;
end;

procedure TFormEmpire.FormShow(Sender: TObject);
var
  i: Integer;
begin
  if not nthShow then
...
procedure TFormEmpire.GLSceneViewerBeforeRender(Sender: TObject);
begin
...
procedure TFormEmpire.GLSceneViewerAfterRender(Sender: TObject);
begin
  ApplyFSAA;
  Screen.Cursor := crDefault;
end;

procedure TFormEmpire.MIAboutClick(Sender: TObject);
begin
  Application.HelpContext(4000);
end;

procedure TFormEmpire.About1Click(Sender: TObject);
begin
  ShowMessage('Communications'#13#10 + 'based on GLS'#13#10#13#10);
end;

procedure TFormEmpire.DoResetCamera;
var
  objSize: Single;
begin
...
procedure TFormEmpire.ApplyShadeModeToMaterial(aMaterial: TGLMaterial);
begin
  with aMaterial do
  begin
...
procedure TFormEmpire.ApplyShadeMode;
var
  i: Integer;
begin
...
procedure TFormEmpire.ApplyFSAA;
begin
...
procedure TFormEmpire.ApplyFaceCull;
begin
  with GLSceneViewer.Buffer do
  begin
...
procedure TFormEmpire.ApplyBgColor;
var
  bmp: TBitmap;
  col: TColor;
begin
...
procedure TFormEmpire.ApplyTexturing;
var
  i: Integer;
begin
  with GLMaterialLibrary.Materials do
...
procedure TFormEmpire.ApplyFPS;
begin
...
procedure TFormEmpire.DoOpen(const fileName: String);
var
  i: Integer;
...
procedure TFormEmpire.ACOpenExecute(Sender: TObject);
begin
...
procedure TFormEmpire.GLSceneViewerMouseDown(Sender: TObject;
...
procedure TFormEmpire.GLSceneViewerMouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
var
  d: Single;
begin
...
procedure TFormEmpire.GLSceneViewerMouseUp(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
  md := False;
end;

procedure TFormEmpire.FormMouseWheel(Sender: TObject; Shift: TShiftState;
  WheelDelta: Integer; MousePos: TPoint; var Handled: Boolean);
begin
...
procedure TFormEmpire.ACZoomInExecute(Sender: TObject);
var
  h: Boolean;
begin
...
procedure TFormEmpire.ACZoomOutExecute(Sender: TObject);
var
  h: Boolean;
begin
  FormMouseWheel(Self, [], 120 * 4, Point(0, 0), h);
...
procedure TFormEmpire.ACShadeSmoothExecute(Sender: TObject);
begin
  ApplyShadeMode;
end;

procedure TFormEmpire.AllBtnsUp;
Begin
...
procedure TFormEmpire.Smoothshading1Click(Sender: TObject);
begin
  AllBtnsUp;
...
procedure TFormEmpire.Flatshading1Click(Sender: TObject);
begin
  AllBtnsUp;
...
procedure TFormEmpire.FlatShadingwithlines1Click(Sender: TObject);
begin
  AllBtnsUp;
...
procedure TFormEmpire.Hiddenlines1Click(Sender: TObject);
begin
  AllBtnsUp;
...
procedure TFormEmpire.Wireframe1Click(Sender: TObject);
begin
  AllBtnsUp;
...
procedure TFormEmpire.MIAADefaultClick(Sender: TObject);
begin
  (Sender as TMenuItem).Checked := True;
  ApplyFSAA;
end;

procedure TFormEmpire.ACResetViewExecute(Sender: TObject);
begin
  DoResetCamera;
end;

procedure TFormEmpire.ACCullFaceExecute(Sender: TObject);
begin
  ACCullFace.Checked := not ACCullFace.Checked;
  ApplyFaceCull;
end;

procedure TFormEmpire.MIBgColorClick(Sender: TObject);
begin
  if ColorDialog.Execute then
    ApplyBgColor;
end;

procedure TFormEmpire.GLMaterialLibraryTextureNeeded(Sender: TObject;
  var textureFileName: String);
begin
...
procedure TFormEmpire.ACTexturingExecute(Sender: TObject);
begin
...
procedure TFormEmpire.MIFileClick(Sender: TObject);
begin
  MIPickTexture.Enabled := (GLMaterialLibrary.Materials.Count > 0);
end;

procedure TFormEmpire.MIPickTextureClick(Sender: TObject);
begin
...
procedure TFormEmpire.MIOpenTexLibClick(Sender: TObject);
var
  i: Integer;
begin
...
procedure TFormEmpire.ACInvertNormalsExecute(Sender: TObject);
var
  i: Integer;
begin
...
procedure TFormEmpire.ACReverseRenderingOrderExecute(Sender: TObject);
var
  i, j, n: Integer;
  fg: TGLFaceGroup;
begin
...
procedure TFormEmpire.ACSaveAsExecute(Sender: TObject);
var
  ext: String;
begin
...
procedure TFormEmpire.ACSaveAsUpdate(Sender: TObject);
begin
...
procedure TFormEmpire.GLCadencerProgress(Sender: TObject;
  const deltaTime, newTime: Double);
begin
  GLSceneViewer.Invalidate;
end;

procedure TFormEmpire.ACFPSExecute(Sender: TObject);
begin
  ACFPS.Checked := not ACFPS.Checked;
  ApplyFPS;
end;

procedure TFormEmpire.TimerTimer(Sender: TObject);
begin
...
procedure TFormEmpire.ACSaveTexturesExecute(Sender: TObject);
begin
...
procedure TFormEmpire.LightMapMaker1Click(Sender: TObject);
begin
  { }
end;

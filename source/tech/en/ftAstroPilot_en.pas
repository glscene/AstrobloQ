...
begin
  ...
  begin
    ...
    try
      ...
      begin
        If FileExists(DataDir + 'Sun.jpg') then
        begin
          with AddTextureMaterial('Sun', DataDir + 'Sun.jpg') do
          ...
          showmessage(DataDir + 'Sun.jpg is missing');

        If FileExists(DataDir + 'Mercury.jpg') then
          with AddTextureMaterial('Mercury', DataDir + 'Mercury.jpg') do
          begin // Create the matlib
            Material.Texture.TextureMode := tmDecal;
        ...
        If FileExists(DataDir + 'Venus.jpg') then
          with AddTextureMaterial('Venus', DataDir + 'Venus.jpg') do
          begin // Create the matlib
            Material.Texture.TextureMode := tmDecal;
        ...
        If FileExists(DataDir + 'Earth.jpg') then
          with AddTextureMaterial('Earth', DataDir + 'Earth.jpg') do
          begin // Create the matlib
            Material.Texture.TextureMode := tmDecal;
        ...
        If FileExists(DataDir + 'Moon.jpg') then
          with AddTextureMaterial('Moon', DataDir + 'Moon.jpg') do
          begin // Create the matlib
            Material.Texture.TextureMode := tmDecal;
        ...
        If FileExists(DataDir + 'Mars.jpg') then
          with AddTextureMaterial('Mars', DataDir + 'Mars.jpg') do
          begin // Create the matlib
            Material.Texture.TextureMode := tmDecal;
        ...
        If FileExists(DataDir + 'Phobos.jpg') then
          with AddTextureMaterial('Phobos', DataDir + 'Phobos.jpg') do
          begin // Create the matlib
            Material.Texture.TextureMode := tmDecal;
        ...
        If FileExists(DataDir + 'Deimos.jpg') then
          with AddTextureMaterial('Deimos', DataDir + 'Deimos.jpg') do
          begin // Create the matlib
            Material.Texture.TextureMode := tmDecal;
        ...
        If FileExists(DataDir + 'Jupiter.jpg') then
          with AddTextureMaterial('Jupiter', DataDir + 'Jupiter.jpg') do
          begin { Create the matlib }
            Material.Texture.TextureMode := tmDecal;
        ...
        If FileExists(DataDir + 'Io.jpg') then
          with AddTextureMaterial('Io', DataDir + 'Io.jpg') do
          begin { Create the matlib }
            Material.Texture.TextureMode := tmDecal;
        ...
        If FileExists(DataDir + 'Europa.jpg') then
          with AddTextureMaterial('Europa', DataDir + 'Europa.jpg') do
          begin { Create the matlib }
            Material.Texture.TextureMode := tmDecal;
        ...
        If FileExists(DataDir + 'Ganymede.jpg') then
          with AddTextureMaterial('Ganymede', DataDir + 'Ganymede.jpg') do
          begin { Create the matlib }
            Material.Texture.TextureMode := tmDecal;
        ...
        If FileExists(DataDir + 'Callisto.jpg') then
          with AddTextureMaterial('Callisto', DataDir + 'Callisto.jpg') do
          begin { Create the matlib }
            Material.Texture.TextureMode := tmDecal;
        ...
        If FileExists(DataDir + 'Saturn.jpg') then
          with AddTextureMaterial('Saturn', DataDir + 'Saturn.jpg') do
          begin { Create the matlib }
            Material.Texture.TextureMode := tmDecal;
        ...
        If FileExists(DataDir + 'Mimas.jpg') then
          with AddTextureMaterial('Mimas', DataDir + 'Mimas.jpg') do
          begin { Create the matlib }
            Material.Texture.TextureMode := tmDecal;
        ...
        If FileExists(DataDir + 'Enceladus.jpg') then
          with AddTextureMaterial('Enceladus', DataDir + 'Enceladus.jpg') do
          begin { Create the matlib }
            Material.Texture.TextureMode := tmDecal;
        ...
        If FileExists(DataDir + 'Tethys.jpg') then
          with AddTextureMaterial('Tethys', DataDir + 'Tethys.jpg') do
          begin { Create the matlib }
            Material.Texture.TextureMode := tmDecal;
        ...
        If FileExists(DataDir + 'Dione.jpg') then
          with AddTextureMaterial('Dione', DataDir + 'Dione.jpg') do
          begin { Create the matlib }
            Material.Texture.TextureMode := tmDecal;
        ...
        If FileExists(DataDir + 'Rhea.jpg') then
          with AddTextureMaterial('Rhea', DataDir + 'Rhea.jpg') do
          begin { Create the matlib }
            Material.Texture.TextureMode := tmDecal;
        ...
        If FileExists(DataDir + 'Titan.jpg') then
          with AddTextureMaterial('Titan', DataDir + 'Titan.jpg') do
          begin { Create the matlib }
            Material.Texture.TextureMode := tmDecal;
        ...
        If FileExists(DataDir + 'Hyperion.jpg') then
          with AddTextureMaterial('Hyperion', DataDir + 'Hyperion.jpg') do
          begin { Create the matlib }
            Material.Texture.TextureMode := tmDecal;
        ...
        If FileExists(DataDir + 'Iapetus.jpg') then
          with AddTextureMaterial('Iapetus', DataDir + 'Iapetus.jpg') do
          begin { Create the matlib }
            Material.Texture.TextureMode := tmDecal;
        ...
        If FileExists(DataDir + 'Phoebe.jpg') then
          with AddTextureMaterial('Phoebe', DataDir + 'Phoebe.jpg') do
          begin { Create the matlib }
            Material.Texture.TextureMode := tmDecal;
        ...
        If FileExists(DataDir + 'Uranus.jpg') then
          with AddTextureMaterial('Uranus', DataDir + 'Uranus.jpg') do
          begin { Create the matlib }
            Material.Texture.TextureMode := tmDecal;
        ...
        If FileExists(DataDir + 'Ariel.jpg') then
          with AddTextureMaterial('Ariel', DataDir + 'Ariel.jpg') do
          begin { Create the matlib }
            Material.Texture.TextureMode := tmDecal;
        ...
        If FileExists(DataDir + 'Umbriel.jpg') then
          with AddTextureMaterial('Umbriel', DataDir + 'Umbriel.jpg') do
          begin { Create the matlib }
            Material.Texture.TextureMode := tmDecal;
        ...
        If FileExists(DataDir + 'Titania.jpg') then
          with AddTextureMaterial('Titania', DataDir + 'Titania.jpg') do
          begin { Create the matlib }
            Material.Texture.TextureMode := tmDecal;
        ...
        If FileExists(DataDir + 'Oberon.jpg') then
          with AddTextureMaterial('Oberon', DataDir + 'Oberon.jpg') do
          begin { Create the matlib }
            Material.Texture.TextureMode := tmDecal;
        ...
        If FileExists(DataDir + 'Miranda.jpg') then
          with AddTextureMaterial('Miranda', DataDir + 'Miranda.jpg') do
          begin { Create the matlib }
            Material.Texture.TextureMode := tmDecal;
        ...
        If FileExists(DataDir + 'Neptune.jpg') then
          with AddTextureMaterial('Neptune', DataDir + 'Neptune.jpg') do
          begin { Create the matlib }
            Material.Texture.TextureMode := tmDecal;
        ...
        If FileExists(DataDir + 'Triton.jpg') then
          with AddTextureMaterial('Triton', DataDir + 'Triton.jpg') do
          begin { Create the matlib }
            Material.Texture.TextureMode := tmDecal;
        ...
        If FileExists(DataDir + 'Nereid.jpg') then
          with AddTextureMaterial('Nereid', DataDir + 'Nereid.jpg') do
          begin { Create the matlib }
            Material.Texture.TextureMode := tmDecal;
        ...
        If FileExists(DataDir + 'Larissa.jpg') then
          with AddTextureMaterial('Larissa', DataDir + 'Larissa.jpg') do
          begin { Create the matlib }
            Material.Texture.TextureMode := tmDecal;
        ...
        If FileExists(DataDir + 'Proteus.jpg') then
          with AddTextureMaterial('Proteus', DataDir + 'Proteus.jpg') do
          begin { Create the matlib }
            Material.Texture.TextureMode := tmDecal;
        ...
        If FileExists(DataDir + 'Pluto.jpg') then
          with AddTextureMaterial('Pluto', DataDir + 'Pluto.jpg') do
          begin { Create the matlib }
            Material.Texture.TextureMode := tmDecal;
        ...
        If FileExists(DataDir + 'Charon.jpg') then
          with AddTextureMaterial('Charon', DataDir + 'Charon.jpg') do
          begin { Create the matlib }
            Material.Texture.TextureMode := tmDecal;
...
var
  f: Single;
begin
  if (WheelDelta > 0) or ( { GLCameraControler } SceneCamera.Position.VectorLength > 0.90) then
  begin

...
var
  FormLoadSmdMdl: TFormLoadSmdMdl;
...
begin
  top := FormLoadSmdMdlY;
  left := FormLoadSmdMdlX;
end;
procedure TFormLoadSmdMdl.FormShow(Sender: TObject);
begin
  FormLoadSmdMdl.Cursor:=crDefault;
end;

procedure TFormLoadSmdMdl.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  FormLoadSmdMdlY := FormLoadSmdMdl.top;
  FormLoadSmdMdlX := FormLoadSmdMdl.left;
  ModalResult:=mrOK;
end;


procedure TFormLoadSmdMdl.MDLoadBtnClick(Sender: TObject);
begin
...
procedure TFormLoadSmdMdl.DoMdlOpen(const FileName : TFileName);
var
  MDL            : file;
  I              : integer;
...
procedure TFormLoadSmdMdl.PrintBtnClick(Sender: TObject);
{FileNameLabel
LBMDL
LBBoneController
LBBones
...
procedure TFormLoadSmdMdl.QcPrintBtnClick(Sender: TObject);
begin
  // The parameter string shows in the print queue under "Document   // name".
  RichEdit1.Print(QcFileNameLabel.Caption);
end;

procedure TFormLoadSmdMdl.QcLoadBtnClick(Sender: TObject);
begin
...
procedure TFormLoadSmdMdl.QcSaveBtnClick(Sender: TObject);
begin

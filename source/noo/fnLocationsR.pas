...
procedure TfrmLocations.FormClose(Sender: TObject;
...
procedure TfrmLocations.AddtoTypeBtnClick(Sender: TObject);
begin
...
procedure TfrmLocations.SaveTypeList;
var
  F :TextFile;
  i : integer;
  sType : string;
...
procedure TfrmLocations.SaveColors;
var
  F :TextFile;
  i : integer;
  scolor : string;
...
procedure TfrmLocations.OkBitBtnClick(Sender: TObject);
var
  F:TextFile;
  Lat,Lon:single;
...
procedure TfrmLocations.OpenBtnClick(Sender: TObject);
begin
  RichEdit1.Lines.LoadFromFile(EarthDataPath+'EarthLoco.txt');
end;

procedure TfrmLocations.WordWrapCBClick(Sender: TObject);
begin
  RichEdit1.WordWrap:= WordWrapCB.Checked;
end;

procedure TfrmLocations.SaveBtnClick(Sender: TObject);
begin
  RichEdit1.Lines.SavetoFile(EarthDataPath+'EarthLoco.txt');
end;

procedure TfrmLocations.PrintBtnClick(Sender: TObject);
begin
  RichEdit1.Print(EarthDataPath+'EarthLoco.txt');
end;

procedure TfrmLocations.ColorPanelClick(Sender: TObject);
begin
...
procedure TfrmLocations.ResetDefaultsBtnClick(Sender: TObject);
begin
  ColorIndex := 7;
  ...
  cbTypes.ItemIndex := 0;
  frmNoosfera.cbTypes.Clear;
  // frmNoosfera.cbTypes.Items.Add(S);
  frmNoosfera.cbTypes.Items := cbTypes.Items; // copied items to main form
  frmNoosfera.cbTypes.ItemIndex := 0;
end;

procedure TfrmLocations.SaveListBtnClick(Sender: TObject);
begin
  SaveTypeList;
end;

procedure TfrmLocations.SaveColorsBtnClick(Sender: TObject);
begin
  SaveColors;
end;

procedure TfrmLocations.PhotoBtnClick(Sender: TObject);
begin
...
procedure TfrmLocations.HelpBtnClick(Sender: TObject);
begin

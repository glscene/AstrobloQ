...
TFileName __fastcall TFormNooneta::GetAssetsDir()
{
	...
	int N = AssetsDir.Pos("astrobloq");
	if (N > 0)
		AssetsDir = AssetsDir.SubString(0, N - 1);

	AssetsDir = IncludeTrailingPathDelimiter(AssetsDir) + "astrobloq\\assets";

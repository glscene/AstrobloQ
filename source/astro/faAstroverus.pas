...
procedure TfrmAstroverus.FormCreate(Sender: TObject);
begin
  inherited;
...
//--------------------------------------------------------------------
procedure TfrmAstroverus.FormShow(Sender: TObject);
begin
  // Planets
...
//------------------------------------------------------------------
procedure TfrmAstroverus.LoadConstLines(const aDataPath: TFileName);
var
  sl, line: TStrings;
...
//------------------------------------------------------------------
procedure TfrmAstroverus.LoadConstBorders(const aDataPath: TFileName);
var
  sl, line: TStrings;
...
//------------------------------------------------------------------
procedure TfrmAstroverus.LoadStarBayers(const aDataPath: TFileName);
begin
  //
end;
...
//------------------------------------------------------------------
procedure TfrmAstroverus.GLCadencerProgress(Sender: TObject;
...
//----------------------------------------------------------------------------
procedure TfrmAstroverus.tvConstellationsClick(Sender: TObject);
begin
  VirtualImageChart.ImageIndex := tvConstellations.Selected.Index;
end;

//----------------------------------------------------------------------------
procedure TfrmAstroverus.tvConstellationsContextPopup(Sender: TObject;
...
//--------------------------------------------------------------------------
procedure TfrmAstroverus.tvPlanetsClick(Sender: TObject);
begin
...
//----------------------------------------------------------------------------
procedure TfrmAstroverus.tvZodiacsClick(Sender: TObject);
begin
  VirtualImageFigures.ImageIndex := tvZodiacs.Selected.ImageIndex;
end;

procedure TfrmAstroverus.miConstPolygonsClick(Sender: TObject);
begin
...
procedure TfrmAstroverus.miTopoCoordinatesClick(Sender: TObject);
begin
...
procedure TfrmAstroverus.miHercrusselClick(Sender: TObject);
begin
...
procedure TfrmAstroverus.miHipparcosClick(Sender: TObject);
begin
...
procedure TfrmAstroverus.miOpenClick(Sender: TObject);
begin
  //
end;

//----------------------------------------------------------------------------
procedure TfrmAstroverus.miPointtoClick(Sender: TObject);
begin
...
//----------------------------------------------------------------------------
procedure TfrmAstroverus.miOptionsClick(Sender: TObject);
begin
  frmOptions.Show;
end;

//----------------------------------------------------------------------------
procedure TfrmAstroverus.miHelpAboutClick(Sender: TObject);
begin
...
//----------------------------------------------------------------------------
procedure TfrmAstroverus.Astromif1Click(Sender: TObject);
begin
...
procedure TfrmAstroverus.chbAxiesClick(Sender: TObject);
begin
  sfPlanet.ShowAxes := frmOptions.CheckBoxAxes.Checked;
end;

//----------------------------------------------------------------------------
procedure TfrmAstroverus.chbPlanetGridClick(Sender: TObject);
begin
...
//----------------------------------------------------------------------------
procedure TfrmAstroverus.miHelpWikiClick(Sender: TObject);
begin
  // if en then
  miHelpWiki.Caption := tvPlanets.Selected.Text + ' in ' + 'Wikipedia...';
...
//----------------------------------------------------------------------------
procedure TfrmAstroverus.miExitClick(Sender: TObject);
begin
  Close;
end;

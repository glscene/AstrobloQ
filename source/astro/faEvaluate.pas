...
begin
  ...
  FormPlotStars.xArrow.Visible := dzdx_dzdy.Checked;
  FormPlotStars.yArrow.Visible := dzdx_dzdy.Checked;
  DoEvaluate;
  Altered := True;
end;
...
begin
  ...
  FormPlotStars.xCoordLine.LineWidth := w;
  FormPlotStars.yCoordLine.LineWidth := w;
  FormPlotStars.zCoordLine.LineWidth := w;
  Altered := True;
end;
...
begin
  ...
  begin
    ...
    FormPlotStars.xCoordLine.LineWidth := CoordWidth;
    FormPlotStars.yCoordLine.LineWidth := CoordWidth;
    FormPlotStars.zCoordLine.LineWidth := CoordWidth;
  end;
end;

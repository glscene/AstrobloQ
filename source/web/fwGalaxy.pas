...
type
  ...
  private
    MousePoint: TPoint;
    DataDir, StarDir, CubeMap,
    CurrentStar: TFileName;
...
procedure TFormGalaxy.AnyChange(Sender: TObject);
begin
  ShowMesh;
end;

procedure TFormGalaxy.ArrowsCheckBoxClick(Sender: TObject);
begin
...
//--------------------------------------------------------------------------
procedure TFormGalaxy.Button1Click(Sender: TObject);
begin
  ...
  begin
    ...
    begin
      ...
      Picture[cmtPX].LoadFromFile('mw_left.jpg');
      Picture[cmtNX].LoadFromFile('mw_right.jpg');
      Picture[cmtPY].LoadFromFile('mw_top.jpg');
      Picture[cmtNY].LoadFromFile('mw_bot.jpg');
      Picture[cmtPZ].LoadFromFile('mw_back.jpg');
      Picture[cmtNZ].LoadFromFile('mw_front.jpg');
    end;
...
procedure TFormGalaxy.GLSceneViewer1MouseDown(Sender: TObject;
...
procedure TFormGalaxy.GLSceneViewer1MouseMove(Sender: TObject; Shift: TShiftState;
  X, Y: Integer);
var
  dx, dy: Integer;
  nx, nz, d: TGLFloat;
...
procedure TFormGalaxy.GLSceneViewer1MouseUp(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
  Screen.Cursor := crDefault;
end;

procedure TFormGalaxy.GridCheckBoxClick(Sender: TObject);
begin
  GLXYZGridXZ.Visible := not GridCheckBox.Checked;
end;

procedure TFormGalaxy.ShowCameraLocation;
begin
...
procedure TFormGalaxy.ShowFocalLength;
begin
  with GLCamera1 do
...
procedure TFormGalaxy.ShowMesh;
type
...
procedure TFormGalaxy.StartTrackBarChange(Sender: TObject);
begin
...
procedure TFormGalaxy.StopTrackBarChange(Sender: TObject);
begin

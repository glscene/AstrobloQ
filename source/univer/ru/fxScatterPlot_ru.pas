...
uses
  ...
  LUX,
  LUX.D2,
  LUX.FMX.ScatterPlotFrame;

type
  TFormScatterPlot = class(TForm)
...
var
  FormScatterPlot: TFormScatterPlot;

implementation

{$R *.fmx}

procedure TFormScatterPlot.FormCreate(Sender: TObject);
var
  I: Integer;
begin

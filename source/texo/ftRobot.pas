...
begin
  frmRobot.Cursor:=crDefault;
end;

procedure TfrmRobot.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  FormLoadModelY := frmRobot.top;
  FormLoadModelX := frmRobot.left;
  ModalResult:=mrOK;
end;


procedure TfrmRobot.MDLoadBtnClick(Sender: TObject);
begin
...
procedure TfrmRobot.DoMdlOpen(const FileName : TFileName);
var
  MDL            : file;
  I              : integer;
...
procedure TfrmRobot.PrintBtnClick(Sender: TObject);
{FileNameLabel
LBMDL
LBBoneController
LBBones
...
procedure TfrmRobot.QcSaveBtnClick(Sender: TObject);
begin

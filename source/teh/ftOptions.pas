...
begin
  ...
  if chbConstLines.Checked then
    frmTehnosferas.LoadConstLines(CurrDir)
  else
    frmTehnosferas.LinesConstellations.Nodes.Clear;
  if chbConstBounds.Checked then
    frmTehnosferas.LoadConstBorders(CurrDir)
  else
    frmTehnosferas.LinesConstBorders.Nodes.Clear;
  }
end;

...
//  fxVolumeRender,
  ...
  FMX.ActnList,
  FMX.StdCtrls  // for translation
  ;

type
  TfrmUniverse = class(TFormO)
    MainMenu: TMainMenu;
    miFile: TMenuItem;
    miOpen: TMenuItem;
    miExit: TMenuItem;
...
procedure TfrmUniverse.ProcessMenu(const AMainMenu: TMainMenu; IsAuto: Boolean);
var
  I: Integer;
begin
...
//---------------------------------------------------------------------------
procedure TfrmUniverse.frmCreate(Sender: TObject);
var
  I: Integer;
begin
  ReadInifile;
...
//---------------------------------------------------------------------------
procedure TfrmUniverse.miStarsysGenClick(Sender: TObject);
begin
  inherited;
...
procedure TfrmUniverse.miVolumeRenderClick(Sender: TObject);
begin
  inherited;
(*
...
//---------------------------------------------------------------------------
procedure TfrmUniverse.miScatterPlotClick(Sender: TObject);
begin
  inherited;
...
procedure TfrmUniverse.miWikiClick(Sender: TObject);
begin
  //
end;
...
procedure TfrmUniverse.miAboutClick(Sender: TObject);
begin
  inherited;

...
type
  ...
  public
    ...
    class operator Multiply(const A_: TSingle2D; const B_: Single)
      : TSingle2D; inline;
    class operator Multiply(const A_: Single; const B_: TSingle2D)
      : TSingle2D; inline;
    class operator Divide(const A_: TSingle2D; const B_: Single)
      : TSingle2D; inline;
  ...
  public
    ...
    class operator Multiply(const A_: TDouble2D; const B_: Double)
      : TDouble2D; inline;
    class operator Multiply(const A_: Double; const B_: TDouble2D)
      : TDouble2D; inline;
    class operator Divide(const A_: TDouble2D; const B_: Double)
      : TDouble2D; inline;
  ...
  public
    ...
    class operator Multiply(const A_: TdSingle2D; const B_: TdSingle)
      : TdSingle2D; inline;
    class operator Multiply(const A_: TdSingle; const B_: TdSingle2D)
      : TdSingle2D; inline;
    class operator Divide(const A_: TdSingle2D; const B_: TdSingle)
      : TdSingle2D; inline;
  ...
  public
    ...
    class operator Multiply(const A_: TdDouble2D; const B_: TdDouble)
      : TdDouble2D; inline;
    class operator Multiply(const A_: TdDouble; const B_: TdDouble2D)
      : TdDouble2D; inline;
    class operator Divide(const A_: TdDouble2D; const B_: TdDouble)
      : TdDouble2D; inline;
  ...
  public
    ...
    class operator Multiply(const A_: TSingleSiz2D; const B_: Single)
      : TSingleSiz2D; inline;
    class operator Multiply(const A_: Single; const B_: TSingleSiz2D)
      : TSingleSiz2D; inline;
    class operator Divide(const A_: TSingleSiz2D; const B_: Single)
      : TSingleSiz2D; inline;
  ...
  public
    ...
    class operator Multiply(const A_: TDoubleSiz2D; const B_: Double)
      : TDoubleSiz2D; inline;
    class operator Multiply(const A_: Double; const B_: TDoubleSiz2D)
      : TDoubleSiz2D; inline;
    class operator Divide(const A_: TDoubleSiz2D; const B_: Double)
      : TDoubleSiz2D; inline;
  ...
  public
    ...
    class operator Multiply(const A_: TdSingleSiz2D; const B_: TdSingle)
      : TdSingleSiz2D; inline;
    class operator Multiply(const A_: TdSingle; const B_: TdSingleSiz2D)
      : TdSingleSiz2D; inline;
    class operator Divide(const A_: TdSingleSiz2D; const B_: TdSingle)
      : TdSingleSiz2D; inline;
  ...
  public
    ...
    class operator Multiply(const A_: TdDoubleSiz2D; const B_: TdDouble)
      : TdDoubleSiz2D; inline;
    class operator Multiply(const A_: TdDouble; const B_: TdDoubleSiz2D)
      : TdDoubleSiz2D; inline;
    class operator Divide(const A_: TdDoubleSiz2D; const B_: TdDouble)
      : TdDoubleSiz2D; inline;
  ...
  public
    ...
    constructor Create(const MinX_, MinY_, MaxX_, MaxY_: Single); overload;
  ...
  public
    ...
    constructor Create(const MinX_, MinY_, MaxX_, MaxY_: Double); overload;
...
class operator TSingle2D.Multiply(const A_: TSingle2D; const B_: Single)
  : TSingle2D;
begin
  with Result do
  begin
...
class operator TSingle2D.Multiply(const A_: Single; const B_: TSingle2D)
  : TSingle2D;
begin
  with Result do
  begin
...
class operator TSingle2D.Divide(const A_: TSingle2D; const B_: Single)
  : TSingle2D;
begin
  with Result do
  begin
...
begin
  Result := ArcTan2(X * V_.Y - Y * V_.X, X * V_.X + Y * V_.Y);
end;
...
begin
  Result.X := System.Math.RandG(0, 1);
  Result.Y := System.Math.RandG(0, 1);
end;
...
class operator TDouble2D.Multiply(const A_: TDouble2D; const B_: Double)
  : TDouble2D;
begin
  with Result do
  begin
...
class operator TDouble2D.Multiply(const A_: Double; const B_: TDouble2D)
  : TDouble2D;
begin
  with Result do
  begin
...
class operator TDouble2D.Divide(const A_: TDouble2D; const B_: Double)
  : TDouble2D;
begin
  with Result do
  begin
...
class operator TdSingle2D.Multiply(const A_: TdSingle2D; const B_: TdSingle)
  : TdSingle2D;
begin
  with Result do
  begin
...
class operator TdSingle2D.Multiply(const A_: TdSingle; const B_: TdSingle2D)
  : TdSingle2D;
begin
  with Result do
  begin
...
class operator TdSingle2D.Divide(const A_: TdSingle2D; const B_: TdSingle)
  : TdSingle2D;
begin
  with Result do
  begin
...
class operator TdDouble2D.Multiply(const A_: TdDouble2D; const B_: TdDouble)
  : TdDouble2D;
begin
  with Result do
  begin
...
class operator TdDouble2D.Multiply(const A_: TdDouble; const B_: TdDouble2D)
  : TdDouble2D;
begin
  with Result do
  begin
...
class operator TdDouble2D.Divide(const A_: TdDouble2D; const B_: TdDouble)
  : TdDouble2D;
begin
  with Result do
  begin
...
class operator TSingleSiz2D.Multiply(const A_: TSingleSiz2D; const B_: Single)
  : TSingleSiz2D;
begin
  with Result do
  begin
...
class operator TSingleSiz2D.Multiply(const A_: Single; const B_: TSingleSiz2D)
  : TSingleSiz2D;
begin
  with Result do
  begin
...
class operator TSingleSiz2D.Divide(const A_: TSingleSiz2D; const B_: Single)
  : TSingleSiz2D;
begin
  with Result do
  begin
...
class operator TDoubleSiz2D.Multiply(const A_: TDoubleSiz2D; const B_: Double)
  : TDoubleSiz2D;
begin
  with Result do
  begin
...
class operator TDoubleSiz2D.Multiply(const A_: Double; const B_: TDoubleSiz2D)
  : TDoubleSiz2D;
begin
  with Result do
  begin
...
class operator TDoubleSiz2D.Divide(const A_: TDoubleSiz2D; const B_: Double)
  : TDoubleSiz2D;
begin
  with Result do
  begin
...
class operator TdSingleSiz2D.Subtract(const A_, B_: TdSingleSiz2D)
  : TdSingleSiz2D;
begin
  with Result do
  begin
...
class operator TdSingleSiz2D.Multiply(const A_: TdSingleSiz2D;
  const B_: TdSingle): TdSingleSiz2D;
begin
  with Result do
  begin
    X := A_.X * B_;
...
class operator TdSingleSiz2D.Multiply(const A_: TdSingle;
  const B_: TdSingleSiz2D): TdSingleSiz2D;
begin
  with Result do
  begin
    X := A_ * B_.X;
...
class operator TdSingleSiz2D.Divide(const A_: TdSingleSiz2D; const B_: TdSingle)
  : TdSingleSiz2D;
begin
  with Result do
  begin
...
class operator TdDoubleSiz2D.Subtract(const A_, B_: TdDoubleSiz2D)
  : TdDoubleSiz2D;
begin
  with Result do
  begin
...
class operator TdDoubleSiz2D.Multiply(const A_: TdDoubleSiz2D;
  const B_: TdDouble): TdDoubleSiz2D;
begin
  with Result do
  begin
    X := A_.X * B_;
...
class operator TdDoubleSiz2D.Multiply(const A_: TdDouble;
  const B_: TdDoubleSiz2D): TdDoubleSiz2D;
begin
  with Result do
  begin
    X := A_ * B_.X;
...
class operator TdDoubleSiz2D.Divide(const A_: TdDoubleSiz2D; const B_: TdDouble)
  : TdDoubleSiz2D;
begin
  with Result do
  begin
...
begin
  case I_ of
    0:
      Result := TSingle2D.Create(Min.X, Min.Y);
    1:
      Result := TSingle2D.Create(Max.X, Min.Y);
    2:
      Result := TSingle2D.Create(Min.X, Max.Y);
    3:
      Result := TSingle2D.Create(Max.X, Max.Y);
  end;
end;
...
begin
  Create(Min_, Min_, Max_, Max_);
end;

constructor TSingleArea2D.Create(const MinX_, MinY_, MaxX_, MaxY_: Single);
begin
  with Min do
  begin
    X := MinX_;
...
begin
  Result := TSingleArea2D.Create(+Single.MaxValue, -Single.MaxValue);
end;
...
begin
  Result := ProjX.Collision(Area_.ProjX) and ProjY.Collision(Area_.ProjY);
end;
...
begin
  case I_ of
    0:
      Result := TDouble2D.Create(Min.X, Min.Y);
    1:
      Result := TDouble2D.Create(Max.X, Min.Y);
    2:
      Result := TDouble2D.Create(Min.X, Max.Y);
    3:
      Result := TDouble2D.Create(Max.X, Max.Y);
  end;
end;
...
constructor TDoubleArea2D.Create(const MinX_, MinY_, MaxX_, MaxY_: Double);
begin
  with Min do
  begin
    X := MinX_;
...
begin
  Result := TDoubleArea2D.Create(+Double.MaxValue, -Double.MaxValue);
end;

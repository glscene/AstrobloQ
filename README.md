...
- численное решение парадокса Ферми для различной плотности распределения техносфер в зонах обитаемости  Галактики, связанных в единую глобальную сеть CETI или в локальные коммуникационные сети, предполагается для I и II типов КЦ по шкале Кардашёва.

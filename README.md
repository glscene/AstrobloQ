...
Программный комплекс AstrobloQ построения виртуальной модели Галактики и её эволюции. 
...
Проекты на базе комплекса AstrobloQ могут быть как публичными, так и приватными, в том числе коммерческими. 

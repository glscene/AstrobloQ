...
построения модели эволюции Млечного Пути и визуализации цифровой сцены Вселенной. 
В разработке применяются кросс-платформенные компоненты VCL/FMX и GLScene/GXScene для языков C++ & Delphi 
с возможностью подключения встроенного CyberAI и внешнего помощника AI-Assistant. 

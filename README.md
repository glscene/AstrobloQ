...
Программный комплекс AstrobloQ предназначен для моделирования Галактики и создания цифровой сцены Вселенной. 
В разработке применяются кросс-платформенные компоненты VCL/FMX и GLScene/GXScene для языков C++ & Delphi, 
планируется подключение внутреннего ИИ и внешних GigaCode и AI-Assistant. 
...
при разработке стартапов в [организациях](https://gitverse.ru/UniverseCETI/GalaxyCETI/) в проектах по астрономии и космонавтике. 

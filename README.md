...
- численное решение парадокса Циолковского-Ферми TFP в Галактиках с переменной плотностью распределения техносфер, связанных коммуникационныыми сетями CETI между I, II и III типов КЦ по шкале академика РАН Н.С.Кардашёва.

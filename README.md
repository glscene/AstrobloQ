...
- потенциал обитаемости GalaxyAI с моделями техносфер, способных к межзвёздным контактам на различных этапах коэволюции, оценивается по диаграмме GalaxyVoronoi и сравнивается с результатами вероятностной оценки по эмпирической формуле Дрейка;
- численное решение парадокса Циолковского-Ферми TFP в Галактиках с переменной плотностью распределения техносфер, связанных коммуникационныыми сетями CETI между I, II и III типами КЦ по шкале академика РАН Н.С.Кардашёва.
